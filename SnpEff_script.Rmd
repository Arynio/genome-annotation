...
```{r Annotation (basic) using the contemporary lp and ll VCFs, eval=FALSE, engine='bash'}
...
POPLIST=($(ls l*[^pv]_perpop_standard_filter.vcf)) #selects all standard-filtered populational VCFs except for País Vasco
for pop in "${POPLIST[@]}"
  do
  echo "${pop}"
  #done
...
```{r Annotation (detailed) using the contemporary lp and ll VCFs, eval=FALSE, engine='bash'}
...
##Annotate the contemporary VCFs with custom annotation
