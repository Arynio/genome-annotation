...
cd $V_PATH/annotation/
screen -S perspecies.ann.log
script perspecies.ann.log
...
##Apply low and high DP and high missingness filters.
...
grep -v '#' /home/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/annotation/c_ll_no_perpop/c_ll_no_perpop_with1.lr_ann.vcf | wc -l #1861579
grep -v '#' /home/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/annotation/c_ll_po_perpop/c_ll_po_perpop_with1.lr_ann.vcf | wc -l #1915319
grep -v '#' /home/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/annotation/c_ll_ki_perpop/c_ll_ki_perpop_with1.lr_ann.vcf | wc -l #2353141
grep -v '#' /home/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/annotation/c_lp_do_perpop/c_lp_do_perpop_with1.lr_ann.vcf | wc -l #1343707
grep -v '#' /home/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/annotation/c_lp_sm_perpop/c_lp_sm_perpop_with1.lr_ann.vcf | wc -l #1708918
...
IND_VCFS=$(find $V_PATH/annotation/ -name "*individual_with1.lr_ann.vcf" | grep -v 'wout1')
for ind in ${IND_VCFS[@]}
  do
  echo "${ind}"
...
wd <- file.path("/Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios")
setwd(wd)
files <- grep(grep(list.files(file.path("/Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios"), pattern = "lr_ann", full.names=T), pattern='test_allele_counts', inv=T, value=T),pattern='between', value=T)
files
perpop_between_statistics <- data_frame("population"=character(0),"category"=character(0),"value"=numeric(0),"dataset"=character(0))
for (f in c(2,1)) {
  current_file <- read_tsv(files[f])
...
for pop in "${POPLIST[@]}"
  ...
  cd $V_PATH/annotation/
  S_V=$(cat $V_PATH/annotation/snpeff_lp_total_synonymous_with1.txt | wc -l)
  NS_V=$(cat $V_PATH/annotation/snpeff_lp_total_nonsynonymous_with1.txt | wc -l)
