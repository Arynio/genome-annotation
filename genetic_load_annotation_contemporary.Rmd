...
ggsave("head_lp_ll_AF_distribution_all_variants.lr_ann.pdf", width=50, height=50, units="cm", device="pdf", path="/Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/features_frequency_distribution/")
...
$BCF view lp_perspecies.trimmed.lr_ann.vcf -Oz -o lp_perspecies.trimmed.lr_ann.vcf.gz
$BCF index lp_perspecies.trimmed.lr_ann.vcf.gz
