...
!!!NO HAY KINSHIPS!!! VOLVER A CALCULAR TRAS HACER LD PRUNING?
...
zcat *.intergenic.mafs.gz | cut -f6 | sed 1d > *.freq
...
/home/dkleinman/ngsRelate -g $POP.intergenic.glf.gz -n $N_IND -f $POP.freq -z $POP_SHORT.id > $POP.gl.res
...
scp dkleinman@genomics-b.ebd.csic.es:/home/GRUPOS/grupolince/lynx_genomes_5x/relatedness_analysis/ANGSD_relatedness/*.res  /Users/Dani/ownCloud/backup/annotation/g-w_relatedness/NGSrelate
...
remove_ids
write(remove_ids,"/Users/Dani/ownCloud/backup/annotation/g-w_relatedness/network_analysis/c_lp_sm_remove_ids.txt")
...
remove_ids
write(remove_ids,"/Users/Dani/ownCloud/backup/annotation/g-w_relatedness/network_analysis/c_ll_ki_remove_ids.txt")


```

#?: Get annotation statistics for each population.
##Split the VCF into per population VCFs. Generate a VCF for each population.
