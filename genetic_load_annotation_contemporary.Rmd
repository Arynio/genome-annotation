...
for i in ${SPECIES[@]}
  ...
  for j in ${POP[@]}
    ...
    -o $V_PATH/annotation/"${j}"_perpop.ann.vcf \
...
##Subsample populations. Subsample all combinations of individuals from populations to the (per-species) minimum common number.
