...
rm snpeff_population_summary.borrar
echo "species,population,N_total,N_intergenic,N_intronic,N_synonymous,N_missense,N_nonsense,N_missense/synonymous" > snpeff_population_summary.borrar
...
for pop in "${POPLIST[@]}"
  ...
  if [ -e ${pop}_random_subsample.ann.vcf ]; then
    ...
    N_TOTAL=$(grep -v '#' ${pop}_random_subsample.ann.vcf | wc -l)
    N_INTERGENIC=$(grep 'intergenic' ${pop}_random_subsample.ann.vcf | wc -l)
    N_INTRONIC=$(grep 'intron' ${pop}_random_subsample.ann.vcf | wc -l)
    N_SYNONYMOUS=$(grep 'synonymous' ${pop}_random_subsample.ann.vcf | wc -l)
    N_MISSENSE=$(grep 'missense' ${pop}_random_subsample.ann.vcf | wc -l)
    N_NONSENSE=$(grep -e 'lost' -e 'gained' ${pop}_random_subsample.ann.vcf | wc -l)
    N_MISSENSE_SYNONYMOUS=$(echo "scale=3; $N_MISSENSE/$N_SYNONYMOUS" | bc)
    echo "$SPECIES,$POPULATION,$N_TOTAL,$N_INTERGENIC,$N_INTRONIC,$N_SYNONYMOUS,$N_MISSENSE,$N_NONSENSE,$N_MISSENSE_SYNONYMOUS" >> $V_PATH/annotation/snpeff_population_summary.borrar
  else
    echo "Original available"
    N_TOTAL=$(grep -v '#' ${pop}.ann.vcf | wc -l)
    N_INTERGENIC=$(grep 'intergenic' ${pop}.ann.vcf | wc -l)
    N_INTRONIC=$(grep 'intron' ${pop}.ann.vcf | wc -l)
    N_SYNONYMOUS=$(grep 'synonymous' ${pop}.ann.vcf | wc -l)
    N_MISSENSE=$(grep 'missense' ${pop}.ann.vcf | wc -l)
    N_NONSENSE=$(grep -e 'lost' -e 'gained' ${pop}.ann.vcf | wc -l)
    N_MISSENSE_SYNONYMOUS=$(echo "scale=3; $N_MISSENSE/$N_SYNONYMOUS" | bc)
    echo "$SPECIES,$POPULATION,$N_TOTAL,$N_INTERGENIC,$N_INTRONIC,$N_SYNONYMOUS,$N_MISSENSE,$N_NONSENSE,$N_MISSENSE_SYNONYMOUS" >> $V_PATH/annotation/snpeff_population_summary.borrar
  fi
  done
...
rm snpeff_population_summary.borrar
echo "species,population,sample,N_total,N_intergenic,N_intronic,N_synonymous,N_missense,N_nonsense,N_missense/synonymous" > snpeff_individual_summary.borrar
...
for i in "${INDLIST[@]}"
  ...
  N_TOTAL=$(grep -v '#' ${i} | wc -l)
  N_INTERGENIC=$(grep 'intergenic' ${i} | wc -l)
  N_INTRONIC=$(grep 'intron' ${i} | wc -l)
  N_SYNONYMOUS=$(grep 'synonymous' ${i} | wc -l)
  N_MISSENSE=$(grep 'missense' ${i} | wc -l)
  N_NONSENSE=$(grep -e 'lost' -e 'gained' ${i} | wc -l)
  N_MISSENSE_SYNONYMOUS=$(echo "scale=3; $N_MISSENSE/$N_SYNONYMOUS" | bc)
  echo "$SPECIES,$POPULATION,$SAMPLE,$N_TOTAL,$N_INTERGENIC,$N_INTRONIC,$N_SYNONYMOUS,$N_MISSENSE,$N_NONSENSE,$N_MISSENSE_SYNONYMOUS" >> $V_PATH/annotation/snpeff_individual_summary.borrar
  done
