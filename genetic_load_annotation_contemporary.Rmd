...
return vb.make();' -o c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter.vcf c_ll_lp_plus_h_ll_aafilled_SNPs_standard_filter.vcf
...
cd $O_PATH/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter_detailed_annotation/
screen -S c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter.ann.log #open a dettachable screen in case the test takes too long
script c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter.ann.log #initiate the log file
...
cd $C_PATH
java -Xmx16g -jar $S_PATH/snpEff.jar LYPA.23 -v -s $O_PATH/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter_detailed_annotation/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter.ann.html -csvStats $O_PATH/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter_detailed_annotation/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter.ann.csv -interval $C_PATH/data/LYPA23C.GENE.mRNA.CDS.GENE_promoters.GENE_introns.UTRs.ncRNA.lncRNA.lncRNA_introns.lncRNA_promoters.intergenic.nr.bed $V_PATH/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter.vcf > $O_PATH/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter_detailed_annotation/c_ll_lp_plus_h_ll_aafilled_polarized_SNPs_standard_filter.ann.vcf #run this code from the directory where the config is located.
