...
echo -e "species\tpopulation\ttotal_V\tintergenic_V\tintronic_V\tsynonymous_V\tsynonymous_A\tmissense_V\tmissense_A\tnonsense_V\tnonsense_A\tmissense/synonymous_V\tmissense/synonymous_A" > snpeff_population_summary.txt
...
for pop in "${POPLIST[@]}"
  ...
  if [ -e ${pop}_random_subsample.ann.vcf ]; then
    ...
    INTRONIC_V=$(grep 'intron' ${pop}_random_subsample.ann.vcf | wc -l)
    SYNONYMOUS_V=$(grep 'synonymous' ${pop}_random_subsample.ann.vcf | wc -l)
    SYNONYMOUS_A=$(grep 'synonymous' ${pop}_random_subsample.ann.vcf | cut -f8 | cut -d';' -f2 | cut -d'=' -f2 | paste -sd+ | bc)
    MISSENSE_V=$(grep 'missense' ${pop}_random_subsample.ann.vcf | wc -l)
    MISSENSE_A=$(grep 'missense' ${pop}_random_subsample.ann.vcf | cut -f8 | cut -d';' -f2 | cut -d'=' -f2 | paste -sd+ | bc)
    ...
    echo -e "$SPECIES\t$POPULATION\t$TOTAL_V\t$INTERGENIC_V\t$INTRONIC_V\t$SYNONYMOUS_V\t$SYNONYMOUS_A\t$MISSENSE_V\t$MISSENSE_A\t$NONSENSE_V\t$NONSENSE_A\t$MISSENSE_SYNONYMOUS_V\t$MISSENSE_SYNONYMOUS_A" >> $V_PATH/annotation/snpeff_population_summary.txt
  else
    echo "Original available"
    TOTAL_V=$(grep -v '#' ${pop}.ann.vcf | wc -l)
    INTERGENIC_V=$(grep 'intergenic' ${pop}.ann.vcf | wc -l)
    INTRONIC_V=$(grep 'intron' ${pop}.ann.vcf | wc -l)
    SYNONYMOUS_V=$(grep 'synonymous' ${pop}.ann.vcf | wc -l)
    SYNONYMOUS_A=$(grep 'synonymous' ${pop}.ann.vcf | cut -f8 | cut -d';' -f2 | cut -d'=' -f2 | paste -sd+ | bc)
    MISSENSE_V=$(grep 'missense' ${pop}.ann.vcf | wc -l)
    MISSENSE_A=$(grep 'missense' ${pop}.ann.vcf | cut -f8 | cut -d';' -f2 | cut -d'=' -f2 | paste -sd+ | bc)
...
echo -e "species\tpopulation\tsample\ttotal_V\tintergenic_V\tintronic_V\tsynonymous_V\tsynonymous_A\tmissense_V\tmissense_A\tnonsense_V\tnonsense_A\tmissense/synonymous_V\tmissense/synonymous_A" > snpeff_individual_summary.txt
...
for i in "${INDLIST[@]}"
  ...
  INTRONIC_V=$(grep 'intron' ${i} | wc -l)
  SYNONYMOUS_V=$(grep 'synonymous' ${i} | wc -l)
  SYNONYMOUS_A=$(grep 'synonymous' ${i} | cut -f8 | cut -d';' -f2 | cut -d'=' -f2 | paste -sd+ | bc)
  MISSENSE_V=$(grep 'missense' ${i} | wc -l)
  MISSENSE_A=$(grep 'missense' ${i} | cut -f8 | cut -d';' -f2 | cut -d'=' -f2 | paste -sd+ | bc)
  NONSENSE_V=$(grep -e 'lost' -e 'gained' ${i} | wc -l)
  NONSENSE_A=$(grep -e 'lost' -e 'gained' ${i} | cut -f8 | cut -d';' -f2 | cut -d'=' -f2 | paste -sd+ | bc)
  MISSENSE_SYNONYMOUS_V=$(echo "scale=3; $MISSENSE_V/$SYNONYMOUS_V" | bc)
  MISSENSE_SYNONYMOUS_A=$(echo "scale=3; $MISSENSE_A/$SYNONYMOUS_A" | bc)
  echo -e "$SPECIES\t$POPULATION\t$SAMPLE\t$TOTAL_V\t$INTERGENIC_V\t$INTRONIC_V\t$SYNONYMOUS_V\t$SYNONYMOUS_A\t$MISSENSE_V\t$MISSENSE_A\t$NONSENSE_V\t$NONSENSE_A\t$MISSENSE_SYNONYMOUS_V\t$MISSENSE_SYNONYMOUS_A" >> $V_PATH/annotation/snpeff_individual_summary.txt
  done
