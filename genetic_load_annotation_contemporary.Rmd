...
##Option A: add Ancestral Allele annotation to the VCF. Use vcftools to fill the INFO/AA field of the VCF.
...
screen -S c_ll_lp_plus_h_ll_aafilled_SNPs_standard_filter_detailed_annotation.log #open a dettachable screen in case the test takes too long
script c_ll_lp_plus_h_ll_aafilled_SNPs_standard_filter_detailed_annotation.log #initiate the log file
