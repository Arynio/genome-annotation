...
!!! HERE WE SHOULD REMOVE REPETITIVE REGIONS AND THOSE WITH BAD MAPPABILITY... ALSO INDELS AND MULTIALLELIC SNPS... ALSO APPLY STANDARD GATK FILTERS AND THEN SOME. THEN SPLIT BY SPECIES AND APPLY ADDITIONAL FILTERS !!!
...
-o c_ll_lp_plus_h_ll_aafilled_SNPs_standard_filter.vcf !!! RENAME EVERYTHING
