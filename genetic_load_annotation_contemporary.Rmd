...
features_frequency_distribution <- read_delim("/Users/Dani/ownCloud/backup/annotation/genetic_load/features_frequency_distribution/features_frequency_distribution.txt",col_names=c("AF","pop","feat"),delim=" ")
...
for (pop in pops) {
  for (feat in features) {
    ...
    pop_feat_ggplot
    ggsave(paste0(pop,"_",feat,"_AF_distribution"), width=30, height=15, units="cm", device="pdf", path="/Users/Dani/ownCloud/backup/annotation/genetic_load/features_frequency_distribution/")
  }
}
