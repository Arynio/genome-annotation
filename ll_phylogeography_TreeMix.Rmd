...
local_repo <- file.path("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/")
...
source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
pdf(paste0(local_repo,"toy/ll_toy_basic_tree.pdf"),width=20,height=10)
toy_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/toy/toy_out_stem")
toy_out_stem
dev.off()

toy_wout_ba_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/toy/toy_wout_ba_out_stem")
toy_wout_ba_out_stem

#all Eurasian lynx populations
source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
pdf(paste0(local_repo,"eurasian_lynx_out_stem.pdf"),width=20,height=10)
eurasian_lynx_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/all_positions/unrooted/all_pops/eurasian_lynx_out_stem")
...
eurasian_lynx_wout_ba_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/all_positions/unrooted/wout_ba/eurasian_lynx_wout_ba_out_stem")
...
eurasian_lynx_rooted_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/all_positions/rooted/all_pops/eurasian_lynx_rooted_out_stem")
...
eurasian_lynx_rooted_out_stem <- plot_resid("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/all_positions/rooted/all_pops/eurasian_lynx_rooted_out_stem",paste0(local_repo,"all_positions/rooted/all_pops/migration/pop_order"))
eurasian_lynx_rooted_out_stem
dev.off()
...
# eurasian_lynx_rooted_wout_ba_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/eurasian_lynx_rooted_wout_ba_out_stem")
...
eurasian_lynx_rooted_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/all_positions/rooted/wout_ba_w_mo/eurasian_lynx_rooted_wout_ba_w_mo_out_stem")
eurasian_lynx_rooted_out_stem
dev.off()
source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
...
eurasian_lynx_rooted_out_stem <- plot_resid("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/all_positions/rooted/wout_ba_w_mo/eurasian_lynx_rooted_wout_ba_w_mo_out_stem",paste0(local_repo,"all_positions/rooted/wout_ba_w_mo/migration/pop_order"))
eurasian_lynx_rooted_out_stem
dev.off()
...
eurasian_lynx_rooted_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/intergenic/rooted/wout_ba_w_mo/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem")
eurasian_lynx_rooted_out_stem
dev.off()
source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
...
eurasian_lynx_rooted_out_stem <- plot_resid("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/intergenic/rooted/wout_ba_w_mo/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem",paste0(local_repo,"intergenic/rooted/wout_ba_w_mo/migration/pop_order"))
eurasian_lynx_rooted_out_stem
dev.off()
...
#intergenic for all Eurasian lynx populations except for Balkans, with Mongolia grouped, rooted with Lynx rufus, with 1000k SNP blocks, with 0-6 migration events
source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
pdf(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_tree.pdf"),width=20,height=10)
eurasian_lynx_rooted_out_stem <- plot_tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem")
eurasian_lynx_rooted_out_stem
dev.off()
source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
pdf(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_residuals.pdf"),width=20,height=10)
eurasian_lynx_rooted_out_stem <- plot_resid("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem",paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/migration/pop_order"))
eurasian_lynx_rooted_out_stem
dev.off()

for (i in 0:6) {
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration_tree.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_tree(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration"))
  eurasian_lynx_rooted_migration
  dev.off()
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration_residuals.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_resid(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration"),paste0(local_repo,"intergenic/rooted/wout_ba_w_mo_1kSNPs/pop_order"))
  eurasian_lynx_rooted_migration
  dev.off()
}
...
import_tree <- read.tree("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/intergenic/rooted/wout_ba_w_mo/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_3_migration.treeout.gz")
...
##0a: Generate intergenic regions definition for Lynx canadensis.
```{bash}

#I copied the Lynx canadensis reference genome chromosomes length dataframe from: https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/007/474/595/GCF_007474595.1_mLynCan4_v1.p/GCF_007474595.1_mLynCan4_v1.p_assembly_report.txt and uploaded it to the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/lc_ref_all_the_genome.bed dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/reference_genomes/lynx_canadensis
unset SSHPASS

cd /GRUPOS/grupolince/reference_genomes/lynx_canadensis
awk -F"\t" '$3 == "gene" {printf ("%s\t%s\t%s\n", $1, $4-5001, $5+5000)}' lc4.NCBI.nr_main.gff3 > lc4.NCBI.nr_main.genes.plus5000.temp_bed

join -1 1 -2 1 <(LANG=en_EN sort -k1,1 -k2,2n -k3,3n lc_ref_all_the_genome.bed) <(LANG=en_EN sort -k1,1 -k2,2n -k3,3n lc4.NCBI.nr_main.genes.plus5000.temp_bed) | awk -v OFS='\t' '{if ($4<0) {$4="1"} else {$4=$4}; print}' | awk -v OFS='\t' '{if ($5>$3) {$5=$3} else {$5=$5}; print $1,$4,$5}' | bedtools merge -i stdin -d 1 > lc4.NCBI.nr_main.genes.plus5000.bed

rm lc4.NCBI.nr_main.genes.plus5000.temp_bed

bedtools subtract -a lc_ref_all_the_genome.bed -b lc4.NCBI.nr_main.genes.plus5000.bed > lc4.NCBI.nr_main.intergenic.buffer5000.bed

```

##0b: Retrieve intergenic VCFs for each population, and the outgroup.
```{r engine='bash'}

#Enrico generated both the data VCF and the outgroup (Lynx rufus) VCF. He placed them in the folder: /GRUPOS/grupolince/LyCaRef_vcfs

cd /GRUPOS/grupolince/LyCaRef_vcfs
screen -S LyCaRef_intergenic_perpop_vcfs.log
script LyCaRef_intergenic_perpop_vcfs.log

#First, I'll retrieve intergenic positions only:
java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx32g -jar /opt/GATK-3.7/GenomeAnalysisTK.jar \
  -T SelectVariants \
  -R /GRUPOS/grupolince/reference_genomes/lynx_canadensis/lc4.fa \
  -V /GRUPOS/grupolince/LyCaRef_vcfs/ll_wholegenome_LyCa_ref.sorted.filter7.vcf \
  -o /GRUPOS/grupolince/LyCaRef_vcfs/ll_wholegenome_LyCa_ref.sorted.filter7.intergenic.vcf \
  -L /GRUPOS/grupolince/reference_genomes/lynx_canadensis/lc4.NCBI.nr_main.intergenic.buffer5000.bed

#Next, I'll split the VCF into populations. The three bad samples from Balkans will be excluded:
POPS=$(bcftools query -l ll_wholegenome_LyCa_ref.sorted.filter7.vcf | cut -c 1-7 | sort | uniq | grep -v 'h_ll_ba')
for pop in ${POPS[@]}
  do
  echo ${pop}
  grep ${pop} <<< "$(bcftools query -l ll_wholegenome_LyCa_ref.sorted.filter7.intergenic.vcf)" | grep -v 'c_ll_ba_0216' > /GRUPOS/grupolince/LyCaRef_vcfs/${pop}.ids
  java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx32g -jar /opt/GATK-3.7/GenomeAnalysisTK.jar \
    -T SelectVariants \
    -R /GRUPOS/grupolince/reference_genomes/lynx_canadensis/lc4.fa \
    -V /GRUPOS/grupolince/LyCaRef_vcfs/ll_wholegenome_LyCa_ref.sorted.filter7.intergenic.vcf \
    -o /GRUPOS/grupolince/LyCaRef_vcfs/${pop}.intergenic.vcf \
    --sample_file /GRUPOS/grupolince/LyCaRef_vcfs/${pop}.ids
  rm /GRUPOS/grupolince/LyCaRef_vcfs/${pop}.ids
  done


#Retrieve intergenic positions for the Lynx rufus individual:
cd /GRUPOS/grupolince/LyCaRef_vcfs
java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx32g -jar /opt/GATK-3.7/GenomeAnalysisTK.jar \
  -T SelectVariants \
  -R /GRUPOS/grupolince/reference_genomes/lynx_canadensis/lc4.fa \
  -V /GRUPOS/grupolince/LyCaRef_vcfs/lr_macrogen_LyCa_ref.sorted.filter7.vcf \
  -o /GRUPOS/grupolince/LyCaRef_vcfs/lr_macrogen_LyCa_ref.sorted.filter7.intergenic.vcf \
  -L /GRUPOS/grupolince/reference_genomes/lynx_canadensis/lc4.NCBI.nr_main.intergenic.buffer5000.bed

```


##1: Build intergenic TreeMix input. Combine per population allele counts for intergenic SNPs in a single gzipped file matching the required format for TreeMix inputs.

```{r Build intergenic TreeMix input, eval=FALSE, engine='bash'}

#Create the allelic counts file for Eurasian lynx (without the root):
cd /GRUPOS/grupolince/LyCaRef_vcfs
POPLIST=$(ls c_*.intergenic.vcf | cut -c 3-7 | sort | uniq) #selects all populations

cd /GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project
rm SNP_names_treemix_input_intergenic.txt
SNP_LIST=$(ls /GRUPOS/grupolince/LyCaRef_vcfs/c_*.intergenic.vcf | head -1) #any population will be useful to retrieve the SNP list because I didn't trim the subVCFs so all populations have all the SNPs (from their species)
grep -v '#' $SNP_LIST | cut -d$'\t' -f1,2 | LANG=en_EN sort -k1,1 -k2,2n | awk '{print $1"_"$2}' > SNP_names_treemix_input_intergenic.txt
unset POPNAMES #removes the variable so that it starts all over again inside the loop
POPNAMES="SNP"
#echo "pop_name,total_SNPs,homoz_ref,heteroz,homoz_alt,unaccounted,unaccounted_cat" > c_VCF_raw.stats 
for pop in ${POPLIST[@]}
  ...
  POPNAMES=$POPNAMES" "$NAME
  echo $POPNAMES
  SAMPLE_NUMBER=$(/opt/bcftools-1.6/bcftools query -l /GRUPOS/grupolince/LyCaRef_vcfs/c_${pop}.intergenic.vcf | wc -l)
  echo $SAMPLE_NUMBER
  TOTAL_SNPS=$(grep -v '#' /GRUPOS/grupolince/LyCaRef_vcfs/c_${pop}.intergenic.vcf | wc -l) #2481132
  echo $TOTAL_SNPS
  #done
  grep -v '#' /GRUPOS/grupolince/LyCaRef_vcfs/c_${pop}.intergenic.vcf | cut -d$'\t' -f1,2,8 | cut -d$';' -f1,3 --output-delimiter=' ' | cut -d$'=' -f1,2,3 --output-delimiter=' ' | awk '{print $1" "$2" "$6-$4","$4}' | LANG=en_EN sort -k1,1 -k2,2n | awk '{print $1"_"$2" "$3}' > temp_SNP_counts.txt
  #LANG=en_EN join -j 1 <(LANG=en_EN sort -k1,1 -k2,2n SNP_names_treemix_input.txt | awk '{print $1"_"$2}') <(LANG=en_EN sort -k1,1 -k2,2n temp_SNP_counts.txt | awk '{print $1"_"$2" "$3}') > intermediate_file.borrar.txt
  LANG=en_EN join -j 1 SNP_names_treemix_input_intergenic.txt temp_SNP_counts.txt > intermediate_file.borrar.txt
  mv intermediate_file.borrar.txt SNP_names_treemix_input_intergenic.txt
  done
...
LONGNAMES=$(echo $POPNAMES | sed -e "s/ll_ba/Balkans/g; s/ll_ca/Caucasus/g; s/ll_cr/Carpathians/g; s/ll_ka/Khentii/g; s/ll_ki/Kirov/g; s/ll_la/Latvia/g; s/ll_no/Norway/g; s/ll_og/Ömnögovi/g; s/ll_po/Bialowieza/g; s/ll_to/Töv/g; s/ll_tu/Tuva/g; s/ll_ur/Urals/g; s/ll_vl/Vladivostok/g; s/ll_ya/Yakutia/g; s/lr_zz/Rufus/g") #swaps the short names with the full names
echo $LONGNAMES
sed -i -e '1i'"$LONGNAMES"'\' SNP_names_treemix_input_intergenic.txt #adds the headers
#sed -i "1s/.*/$LONGNAMES/" SNP_names_treemix_input.txt #substitutes old headers
...
#Get a version of the TreeMix input that includes Lynx rufus as the outgroup:
cd /GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project
grep -v '#' /GRUPOS/grupolince/LyCaRef_vcfs/lr_macrogen_LyCa_ref.sorted.filter7.intergenic.vcf | cut -d$'\t' -f1,2,8 | cut -d$';' -f1,3 --output-delimiter=' ' | cut -d$'=' -f1,2,3 --output-delimiter=' ' | LANG=en_EN sort -k1,1 -k2,2n | awk '{print $1"_"$2" "$6-$4","$4}' > c_lr_SNP_counts_intergenic.txt #gets the allele counts for all variable positions within the rufus individual
sed -i -e '1i'"SNP Rufus"'\' c_lr_SNP_counts_intergenic.txt #adds column names; #2481133 lines in c_lr_SNP_counts_intergenic.txt

LANG=en_EN join -a1 -e 2,0 -o auto -j 1 <(LANG=en_EN sort -k1 SNP_names_treemix_input_intergenic.txt | tail -n +2) <(LANG=en_EN sort -k1 c_lr_SNP_counts_intergenic.txt | tail -n +2) > intermediate_file.borrar.txt #joins the eurasian lynx allelic counts with the rufus allelic counts, assigning "2,0" for all missing positions from Rufus
LANG=en_EN join -a2 -e 'NA' -o auto -j 1 <(LANG=en_EN sort -k1 SNP_names_treemix_input_intergenic.txt | tail -n +2) <(LANG=en_EN sort -k1 c_lr_SNP_counts_intergenic.txt | tail -n +2) > intermediate_file_2.borrar.txt #joins the eurasian lynx allelic counts with the rufus allelic counts, assigning "NA" for all missing positions from Eurasian
cat intermediate_file.borrar.txt intermediate_file_2.borrar.txt | LANG=en_EN sort -k1 | uniq > intermediate_file_joined.borrar.txt #joins both previous allelic count files in a single one with all variable positions
scp intermediate_file_joined.borrar.txt intermediate_file_joined_2.borrar.txt #duplicates the joined intermediate file
sed -i 's/NA NA NA NA NA NA NA NA NA NA NA NA NA NA/14,0 24,0 12,0 8,0 26,0 12,0 16,0 4,0 16,0 4,0 12,0 12,0 16,0 16,0/g' intermediate_file_joined_2.borrar.txt #replaces all rows with NA in the Eurasian fields with max allelic counts for the reference allele; this should be re-hardcoded if populations are changed
mv intermediate_file_joined_2.borrar.txt SNP_names_treemix_input_intergenic_rooted.txt #final name
sed -i -e '1i'"$LONGNAMES Rufus"'\' SNP_names_treemix_input_intergenic_rooted.txt #adds headers with population names; #6869396 lines in SNP_names_treemix_input_intergenic_rooted.txt
grep -v ' 0,0 ' SNP_names_treemix_input_intergenic_rooted.txt | grep -v ' 0,0$' | cut -d$' ' -f 2- | gzip > treemix_input_intergenic_rooted.txt.gz #removes rows with any missing data, and also the SNP names
rm *.borrar.txt #removes all intermediate files

#Get a version of the rufus-rooted TreeMix input with Khentii, Töv & Ömnögovi grouped together as Mongolia:
cut -d$' ' -f1,5,9,11  SNP_names_treemix_input_intergenic_rooted.txt | tail -n+2 | cut -d$',' -f1,2,3,4 --output-delimiter=' ' | awk '{print $1" "$2+$4+$6","$3+$5+$7}' > SNP_names_threepop_input_intergenic_ka_om_to.txt #sums allele counts for the three Mongolian populations
sed -i '1i\SNP Mongolia' SNP_names_threepop_input_intergenic_ka_om_to.txt #adds correct column names
awk -v f2=SNP_names_treemix_input_intergenic_rooted.txt '{ c = $2; getline < f2; print $0, c; }' SNP_names_threepop_input_intergenic_ka_om_to.txt | cut -d$' ' -f5,9,11 --complement > SNP_names_treemix_input_intergenic_rooted_w_mo.txt #copies the Mongolia column to a new TreeMix input where the three Mongolian populations have been removed
grep -v ' 0,0 ' SNP_names_treemix_input_intergenic_rooted_w_mo.txt | grep -v ' 0,0$' | cut -d$' ' -f 2- | gzip > treemix_input_intergenic_rooted_w_mo.txt.gz #removes rows with any missing data, and also the SNP names

#Fix bobcat name:
scp treemix_input_intergenic_rooted_w_mo.txt.gz treemix_input_intergenic_rooted_w_mo_bis.txt.gz
zcat treemix_input_intergenic_rooted_w_mo_bis.txt.gz | sed 's/Rufus/Bobcat/g' | gzip > treemix_input_intergenic_rooted_w_mo.txt.gz
rm treemix_input_intergenic_rooted_w_mo_bis.txt.gz
...
#Basic command to build a rooted ML tree without Balkans and with Mongolia, followed by a loop that runs TreeMix with different number of migration events
cd /GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project
screen -S treemix_eurasian_lynx_intergenic_rooted_w_mo
script treemix_eurasian_lynx_intergenic_rooted_w_mo.log
#$T_PATH/treemix -i treemix_input_intergenic_rooted_wout_ba_w_mo.txt.gz -root Rufus -k 100 -se -o eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem #replace this with a run with m=0 inside the loop
END=6
for i in $(seq 0 $END)
  do echo "migration events number = " $i
  /opt/treemix-1.12/src/treemix -i treemix_input_intergenic_rooted_w_mo.txt.gz -root Bobcat -k 100 -m ${i} -se -o eurasian_lynx_intergenic_rooted_w_mo_out_stem_"${i}"_migration
  done

#Code to run additional TreeMix runs with M=2. I sent 9 nine additional runs (from run_2 to run_10):
scp treemix_input_intergenic_rooted_w_mo.txt.gz treemix_input_intergenic_rooted_w_mo_bis.txt.gz
zcat treemix_input_intergenic_rooted_w_mo_bis.txt.gz | sed 's/Rufus/Bobcat/g' | gzip > treemix_input_intergenic_rooted_w_mo.txt.gz #First, use this line to replace 'Rufus' with 'Bobcat'
rm treemix_input_intergenic_rooted_w_mo_bis.txt.gz
...
RUN=$((RUN+1))
cd /GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project
screen -S treemix_intergenic_rooted_w_mo_migration_3_run_${RUN}.log
RUN=$(echo ${STY#*.} | cut -d'.' -f1 | rev | cut -d'_' -f1 | rev)
script treemix_intergenic_rooted_w_mo_migration_3_run_${RUN}.log
RUN=$(echo ${STY#*.} | cut -d'.' -f1 | rev | cut -d'_' -f1 | rev)

RANDOMSEED=$(shuf -i 1-100000 -n 1)
echo "TreeMix run" $RUN "with m=3; initial seed is" $RANDOMSEED
/opt/treemix-1.12/src/treemix -i treemix_input_intergenic_rooted_w_mo.txt.gz -root Bobcat -k 100 -m 3 -se -seed $RANDOMSEED -o eurasian_lynx_intergenic_rooted_w_mo_out_stem_3_migration_run_${RUN}

#scp dkleinman@genomics-b.ebd.csic.es:/opt/treemix-1.12/src/plotting_funcs.R /Users/Dani/ownCloud/backup/annotation/TreeMix

#Copy files for intergenic positions trees:
scp dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem*migration.* /Users/dani/ownCloud/backup/g-w_analysis/TreeMix/enrico_project
scp dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_2_migration_run* /Users/dani/ownCloud/backup/g-w_analysis/TreeMix/enrico_project/independent_m_2_runs
scp dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_3_migration_run* /Users/dani/ownCloud/backup/g-w_analysis/TreeMix/enrico_project/independent_m_3_runs
...
local_repo <- file.path("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/")
#poporder <- c("Balkans","Caucasus",Carpathians","Norway","Bialowieza","Latvia","Kirov","Urals","Tuva","Ömnögovi","Töv","Khentii","Mongolia","Yakutia","Vladivostok","Rufus") #save it in a file in the enrico_project folder

#intergenic for all Eurasian lynx populations, with Mongolia grouped, rooted with Lynx rufus, with 0-6 migration events
for (i in 0:6) {
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_migration_tree.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_tree(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_migration"))
  eurasian_lynx_rooted_migration
  dev.off()
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_migration_residuals.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_resid(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_migration"),paste0(local_repo,"enrico_project/pop_order"))
  eurasian_lynx_rooted_migration
  dev.off()
}

#Independent m=2 runs:
for (i in 1:10) {
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"enrico_project/independent_m_2_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_2_migration_run_",i,"_tree.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_tree(paste0(local_repo,"enrico_project/independent_m_2_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_2_migration_run_",i))
  eurasian_lynx_rooted_migration
  dev.off()
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"enrico_project/independent_m_2_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_2_migration_run_",i,"_residuals.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_resid(paste0(local_repo,"enrico_project/independent_m_2_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_2_migration_run_",i),paste0(local_repo,"enrico_project/pop_order"))
  eurasian_lynx_rooted_migration
  dev.off()
}

#Independent m=3 runs:
for (i in 1:10) {
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"enrico_project/independent_m_3_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_3_migration_run_",i,"_tree.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_tree(paste0(local_repo,"enrico_project/independent_m_3_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_3_migration_run_",i))
  eurasian_lynx_rooted_migration
  dev.off()
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"enrico_project/independent_m_3_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_3_migration_run_",i,"_residuals.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_resid(paste0(local_repo,"enrico_project/independent_m_3_runs/eurasian_lynx_intergenic_rooted_w_mo_out_stem_3_migration_run_",i),paste0(local_repo,"enrico_project/pop_order"))
  eurasian_lynx_rooted_migration
  dev.off()
}
...
calcVarExplain <- function(stem){
  #Calculate standard error of covariance matrix
  se = read.table(gzfile(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_migration.covse.gz")), as.is = T, head = T, quote = "", comment.char = "")
  seBar = apply(se, 1, mean)
  seBar = mean(seBar)
  #Read in two covariance matrices
  WHat <- read.table(gzfile(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_migration.cov.gz")), as.is = T, head = T, quote = "", comment.char = "")
  W <- read.table(gzfile(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_migration.modelcov.gz")), as.is = T, head = T, quote = "", comment.char = "")
  #Set row and column names and order properly
  names(WHat) = rownames(WHat)
  names(W) = rownames(W)
  WHat = WHat[order(names(WHat)), order(names(WHat))]
...
fraction_variance_ggplot <- ggplot(data=fraction_variance, aes(x=m,y=variance)) + #[-c(1:3),] to plot from 3 to 6
  ...
  ylab("Fraction of variance") +
  xlab("m (Number of migration events)") +
  scale_y_continuous(breaks=seq(0.9997,1,by=0.00005),labels=seq(0.9997,1,by=0.00005)) +
  theme_bw() +
  theme(text=element_text(size=12,face="bold"),
        rect=element_rect(size=2),
        axis.line=element_line(colour="black"),
...
fraction_variance_ggplot
ggsave("/enrico_project/fraction_of_variance_Phylo2.pdf", width=20, height=10, units="cm", device="pdf", path=local_repo)

```

##Extra: test without the new pops.
```{bash}

cut -d' ' -f1,4- SNP_names_treemix_input_intergenic_rooted_w_mo.txt | grep -v ' 0,0 ' | grep -v ' 0,0$' | cut -d$' ' -f 2- | gzip > treemix_input_intergenic_rooted_test.txt.gz

screen -S treemix_eurasian_lynx_intergenic_rooted_test
script treemix_eurasian_lynx_intergenic_rooted_test.log

/opt/treemix-1.12/src/treemix -i treemix_input_intergenic_rooted_test.txt.gz -root Rufus -k 100 -o eurasian_lynx_intergenic_rooted_w_mo_out_stem_N_test

END=0
for i in $(seq 0 $END)
  do echo "migration events number = " $i
  /opt/treemix-1.12/src/treemix -i treemix_input_intergenic_rooted_test.txt.gz -root Rufus -k 100 -m ${i} -se -o eurasian_lynx_intergenic_rooted_w_mo_out_stem_"${i}"_test
  done

END=0
for i in $(seq 0 $END)
  do echo "migration events number = " $i
  /opt/treemix-1.12/src/treemix -i treemix_input_intergenic_rooted.txt.gz -root Rufus -k 100 -m ${i} -se -o eurasian_lynx_intergenic_rooted_w_mo_out_stem_"${i}"_try
  done


#Copy files for intergenic positions trees:
scp dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_*try* /Users/dani/ownCloud/backup/g-w_analysis/TreeMix/enrico_project
...
for (i in 0:0) {
  source("/Users/Dani/ownCloud/backup/g-w_analysis/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_try_tree.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_tree(paste0(local_repo,"enrico_project/eurasian_lynx_intergenic_rooted_w_mo_out_stem_",i,"_try"))
  eurasian_lynx_rooted_migration
  dev.off()
}
...
cd /GRUPOS/grupolince/lynx_genomes_5x/TreeMix/enrico_project
TOTAL=$(tail -n+2 SNP_names_treemix_input_intergenic_rooted_w_mo.txt | wc -l)
cut -d' ' -f14 SNP_names_treemix_input_intergenic_rooted_w_mo.txt | tail -n+2 | sort | uniq -c | awk -v total="$TOTAL" -F" " '{print $1,$2,100*$1/total}' | sort -k1,1gr > SNP_names_treemix_input_intergenic_rooted_w_mo_percentage.txt


cd /GRUPOS/grupolince/lynx_genomes_5x/TreeMix/intergenic_plus_1000
TOTAL=$(tail -n+2 SNP_names_treemix_input_intergenic_rooted_wout_ba_w_mo.txt | wc -l)
cut -d' ' -f12 SNP_names_treemix_input_intergenic_rooted_wout_ba_w_mo.txt | tail -n+2 | sort | uniq -c | awk -v total="$TOTAL" -F" " '{print $1,$2,100*$1/total}' | sort -k1,1gr > SNP_names_treemix_input_intergenic_rooted_wout_ba_w_mo_percentage.txt
