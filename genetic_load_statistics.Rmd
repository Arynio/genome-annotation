...
derived_freq_ratios_errors_ggplot <- ggplot(data=tidy_derived_freq_ratios,aes(x=populations,y=ratio_value_from1,fill=ratio_type)) +
  geom_bar(stat='identity', position=position_dodge()) +
...
ggsave("c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_ALL_vars_subs_derived_freq_ratio_errors.pdf", width=20, height=15, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/derived_allele_freq_ratio")
