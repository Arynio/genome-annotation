...
if(type=="varssubs") {
  left_title <- "Average genetic load relative to ki"
} else if (type=="fixed") {
  left_title <- "Derived fixation rate relative to ki"
}

average_relativised_derived_allele_allele_ratio_combined <- grid.arrange(set_panel_size(average_relativised_derived_allele_allele_ratio_up,width=unit(4.5,"cm"),height=unit(10,"cm")), set_panel_size(average_relativised_derived_allele_allele_ratio_down,width=unit(4.5,"cm"),height=unit(10,"cm")),set_panel_size(average_relativised_derived_allele_allele_ratio_other,width=unit(4.5,"cm"),height=unit(10,"cm")),widths=c(7,1,0.2),layout_matrix=rbind(c(1,1,NA),c(2,NA,3)),bottom=textGrob(expression(bold("Population")),gp=gpar(fontsize=16,fontface="bold")))

#,left=textGrob(expression(bold(left_title)),rot=90,gp=gpar(fontsize=16,fontface="bold"),vjust=2)
