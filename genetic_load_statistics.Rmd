...
#Option 1: use the normalized ratio:
...
#Option 2: use the non-normalized ratio and include the syn ratio in the variance estimation (it yields the same result).
...
#From outside the server:
scp dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/genetic_load_analysis/derived_allele_freq_ratio/*/*derived_freq_ratio_2SD_SNP.lr_ann.txt /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/derived_allele_freq_ratio/
