...
relativised_derived_allele_allele_ratio_ggplot <- ggplot(data=filter(relativised_variants_and_subst_wg_alleleR,ratio != "synonymous" & ratio != "missense"), aes(population,ki_relative_value,colour=population)) +
  ...
  relativised_derived_allele_allele_ratio_ggplot
ggsave(paste0(type,"_derived_allele_allele_ratio_relative2synonymous_short.pdf"), width=15, height=15, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/")


relativised_derived_allele_allele_ratio_ggplot1 <- ggplot(data=filter(relativised_variants_and_subst_wg_alleleR,ratio == "mistol" | ratio == "misdel"), aes(population,ki_relative_value,colour=population)) +
  #facet_wrap(feature ~ species,nrow=6,ncol=2,scales="free") +
  facet_grid(. ~ ratio) +
  geom_boxplot(width=0.5) +
  #ggtitle("Proportion of reads at different NM") +
...
relativised_derived_allele_allele_ratio_ggplot2 <- ggplot(data=filter(relativised_variants_and_subst_wg_alleleR,ratio == "nonsense" | ratio == "UCNE"), aes(population,ki_relative_value,colour=population)) +
  #facet_wrap(feature ~ species,nrow=6,ncol=2,scales="free") +
  facet_grid(. ~ ratio) +
  geom_boxplot(width=0.5) +
  #ggtitle("Proportion of reads at different NM") +
...
relativised_derived_allele_allele_ratio_ggplotcombined <- grid.arrange(relativised_derived_allele_allele_ratio_ggplot1, relativised_derived_allele_allele_ratio_ggplot2, nrow = 1)
...
######Relative to synonymous (population average version for Aurora).
```{r Plot variant count results}
...
average_relativised_variants_and_subst_wg_alleleR$ratio = factor(average_relativised_variants_and_subst_wg_alleleR$ratio,levels=c("synonymous","missense","mistol","misdel","nonsense","UCNE"))
...
ggsave(paste0(type,"_derived_allele_allele_ratio_relative2synonymous_short_mean.pdf"), width=15, height=15, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/")
...
average_relativised_derived_allele_allele_ratio_ggplot2 <- ggplot(data=filter(average_relativised_variants_and_subst_wg_alleleR,ratio == "nonsense" | ratio == "UCNE"), aes(population,avg_ki_relative_value,colour=population)) +
  #facet_wrap(feature ~ species,nrow=6,ncol=2,scales="free") +
  facet_grid(. ~ ratio) +
  geom_point() +
  geom_errorbar(aes(ymin=avg_ki_relative_value-se_ki_relative_value, ymax=avg_ki_relative_value+se_ki_relative_value), position=position_dodge(), width=0.5) +
  #ggtitle("Proportion of reads at different NM") +
  ylab("population mean ratio") +
  scale_y_continuous(breaks = seq(0.75, 1.10, by = 0.2)) +
  ylim(0.75,1.10) +
  #ggtitle(paste0("ratio of ",type," relative to synonymous and Kirov")) +
  theme_bw() +
  theme(text=element_text(size=12,face="bold"),
...
ggsave(paste0(type,"_derived_allele_allele_ratio_relative2synonymous_part2_mean.pdf"), width=14.6, height=15, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/")
...
variants_het_tidy <- variants_het %>% select(-c(6,8)) %>% gather(feature,N,-species,-population,-dataset,-sample,factor_key=T)
...
ggsave(paste0(type,"_derived_allele_heterozygous_counts.pdf"), width=15, height=20, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/")
...
total_sites <- read_tsv("/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/whole_genome_counts/category_sites_total_counts_percategoryfilter.lr_ann.txt") 
total_sites
...
for (row in seq(1,nrow(coding_proportions))) {
  ...
  print(proportion)
  total_sites <- rbind(total_sites,c(coding_category,round(proportion*unlist(total_sites[which(total_sites$category=="CDS"),2],use.names=F)),round(proportion*unlist(total_sites[which(total_sites$category=="CDS"),3],use.names=F))))
  total_sites$total_N <- as.numeric(total_sites$total_N)
  total_sites$total_N_postfilter <- as.numeric(total_sites$total_N_postfilter)
}
total_sites
total_sites$category <- factor(total_sites$category,levels=c("total","intergenic","intron","CDS","synonymous","missense","mistol","misdel","nonsense","UCNE"))
total_sites <- total_sites[order(total_sites$category),]
write_tsv(total_sites,paste0("/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/whole_genome_counts/complete_category_sites_total_counts_percategoryfilter.lr_ann.txt"))

variants_het_joined_all <- left_join(variants_het_tidy,total_sites,by=c("feature"="category")) %>% mutate(het_by_total=N/total_N,het_by_total_filter=N/total_N_postfilter)
variants_het_joined_all$feature = factor(variants_het_joined_all$feature,levels=c("total","intergenic","intron","CDS","synonymous","missense","mistol","misdel","nonsense","UCNE")) 
...
average_variants_het_joined_all$feature = factor(average_variants_het_joined_all$feature,levels=c("total","intergenic","intron","CDS","synonymous","missense","mistol","misdel","nonsense","UCNE"))
...
#Plot these means and standard errors (except for nonsense and UCNE, that need a different scale):
average_ggplot_all_pi_part1 <- ggplot(data=filter(average_variants_het_joined_all,feature != "nonsense" & feature != "UCNE"), aes(population,avg_het_by_total,colour=population)) +
  #facet_wrap(feature ~ species,nrow=6,ncol=2,scales="free") +
  facet_grid(feature ~ .) +
  geom_point() +
...
ggsave(paste0(type,"_all_",plot_variable,"_joint_calling_joint_estimate_mean_part1.pdf"), width=10, height=25, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/genetic_load_vs_diversity")

#Plot these means and standard errors (for nonsense and UCNE, that need a different scale):
average_ggplot_all_pi_part2 <- ggplot(data=filter(average_variants_het_joined_all,feature == "nonsense" | feature == "UCNE"), aes(population,avg_het_by_total,colour=population)) +
  #facet_wrap(feature ~ species,nrow=6,ncol=2,scales="free") +
  facet_grid(feature ~ .) +
  geom_point() +
  geom_errorbar(aes(ymin=avg_het_by_total-se_het_by_total, ymax=avg_het_by_total+se_het_by_total), position=position_dodge(), width=0.5) +
...
ggsave(paste0(type,"_all_",plot_variable,"_joint_calling_joint_estimate_mean_part2.pdf"), width=10, height=10, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/genetic_load_vs_diversity")


#Old: calculate PI per site for coding categories using the whole CDS category as denominator:
...
variants_het <- read_tsv(paste0(wd_path,variant_files)) %>% select(-c(24:27))
...
variants_het_joined_all <- left_join(variants_het_tidy,total_sites,by=c("feature"="category")) %>% mutate(rda_by_total=N/total_N,rda_by_total_filter=N/total_N_postfilter)
variants_het_joined_all$feature = factor(variants_het_joined_all$feature,levels=c("total","intergenic","intron","CDS","synonymous","missense","missense_tol","missense_del","nonsense","UCNE")) 
variants_het_joined_all
...
average_variants_het_joined_all
average_variants_het_joined_all$population = factor(average_variants_het_joined_all$population,levels=c("ki","no","po","sm","do"))
average_variants_het_joined_all$feature = factor(average_variants_het_joined_all$feature,levels=c("total","intergenic","intron","CDS","synonymous","missense","missense_tol","missense_del","nonsense","UCNE"))
...
#Plot these means and standard errors (except for nonsense and UCNE, that need a different scale):
average_ggplot_all_pi_part1 <- ggplot(data=filter(average_variants_het_joined_all,feature != "nonsense" & feature != "UCNE"), aes(population,avg_rda,colour=population)) +
  #facet_wrap(feature ~ species,nrow=6,ncol=2,scales="free") +
  facet_grid(feature ~ .) +
  geom_point() +
...
#Plot these means and standard errors (for nonsense and UCNE, that need a different scale):
average_ggplot_all_pi_part2 <- ggplot(data=filter(average_variants_het_joined_all,feature == "nonsense" | feature == "UCNE"), aes(population,avg_rda,colour=population)) +
  #facet_wrap(feature ~ species,nrow=6,ncol=2,scales="free") +
  facet_grid(feature ~ .) +
  geom_point() +
  geom_errorbar(aes(ymin=avg_rda-se_rda, ymax=avg_rda+se_rda), position=position_dodge(), width=0.5) +
...
cd $V_PATH/$CALLING/annotation
ALL_SITES_FILE=$(echo /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/complete_category_sites_total_counts_percategoryfilter.lr_ann.txt)
...
for p in "${POPLIST[@]}"
  ...
  for c in ${CATEGORIES[@]}
    ...
    TOTAL_N=$(grep -w "${c}" "$ALL_SITES_FILE" | cut -f3)
