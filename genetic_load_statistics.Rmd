...
for f in ${DEL_FEATURES[@]}
  ...
  paste <(head ${CALLING}_ALL_derived_freq_ratio_${TYPE}.txt -n1) <(head ${CALLING}_temp_derived_freq_ratio_${TYPE}.borrar -n1) > "${CALLING}"_joint_derived_freq_ratio.borrar
