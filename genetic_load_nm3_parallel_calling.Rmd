---
title: "genetic_load_nm3_parallel_calling"
output: html_document
---

#1. Write GATK calling script.
...
-T HaplotypeCaller \
-R $REF \
$(for var in $SAMPLES; do if [ -e /GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_nm_filtered/${var}_recal_round-1_25x.nm3.bam ]; then echo -I /GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_nm_filtered/${var}_recal_round-1_25x.nm3.bam" "; else echo -I /GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_nm_filtered/${var}_recal_round-1.nm3.bam" "; fi; done) \
...
#2. Upload GATK calling script to the server.
```{r, eval=FALSE, engine='bash'}

#Save it in a text editor as /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/GATK_calling.nm3.sh and upload it to the server:
CALLING=(c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm3nm3_origcov)
scp /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/GATK_calling.nm3.sh dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/

#Then inside the server change permissions to run it:
cd GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/
chmod +x GATK_calling.nm3.sh

```

#3. Divide the genome in chunks.
```{r, eval=FALSE, engine='bash'}
...
REGIONS=$(realpath /home/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/bed_file_all_the_genome_chunks/bed_file_lp23.*_to_*.bed)
NL=$'\n'
...
for r in ${REGIONS[@]}
  ...
  screen -S "${CALLING}-${SCAFFOLDS}" -p 0 -X stuff "time ./GATK_calling.nm3.sh; exec bash$NL"
