...
mv /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/GATK_calling.nm3.sh /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/$CALLING/GATK_calling.nm3.sh 
...
grep -v '#' ${CALLING}.vcf | wc -l #5839239
