...
##Separate true variants and true substitutions. These are defined at the species level.
```{r Filter the annotated VCF, eval=FALSE, engine='bash'}
...
##Separate variants and substitutions. These are badly defined.
```{r Filter the annotated VCF, eval=FALSE, engine='bash'}
...
##For true varssubs, false variants and false substitutions. All of these should be filtered next (steps 10 and 11).
...
##For true variants and substitutions. These come from the already filtered varssubs, so steps 10 and 11 should be skipped. Go straight to step 12 after this.
```{r Obtain per dataset VCFs, eval=FALSE, engine='bash'}
