...
grep -v '#' c_lp_sm_c_lp_do_nm2_samecov_aafilled.vcf | wc -l #3651792
...
grep -v '#' c_lp_sm_c_lp_do_nm2_samecov_polarized.vcf | wc -l #3651792
...
cd $V_PATH/annotation/
grep -v '#' c_lp_sm_c_lp_do_nm2_samecov_polarized.lr_ann.vcf | wc -l #3651792
...
for i in ${POP[@]}
  ...
  for j in ${INDIVIDUALS[@]}
    ...
    -o "${i}"_"${NM_COV}"_individuals/"${i}"_"${NM_COV}"_individual.lr_ann.vcf \
    -env \
    -sn $ID
    done
  done
