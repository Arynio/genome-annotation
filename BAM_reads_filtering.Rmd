...
grep -v '#' "${CALLING}_aafilled.vcf" | wc -l #3651792
...
###Separate per-species calling. Monomorphic positions (incl. substitutions) are NOT polarized. Grab substitutions from the joint dataset.
...
###Joint calling. Substitutions should be retrieved from this joint dataset.
