...
#c_lp_sm_c_lp_do_nm2_samecov 1068346
#c_ll_ki_c_ll_no_c_ll_po_nm3_samecov 2017309
#c_lp_sm_c_lp_do_nm2_origcov 1019023
#c_ll_ki_c_ll_no_c_ll_po_nm3_origcov 2027157

```

#9: Depth range calculus. Obtain depth range for each species in order to filter low/high depth positions as part of the next section's many filterings.
...
for i in ${DATASETS[@]}
  do
    ...
    cd /home/dkleinman/datos/nm_depth_calculus
    screen -dmS "${i}_${COVERAGE}_${N_SIZE}.log"
    screen -S "${i}_${COVERAGE}_${N_SIZE}.log" -p 0 -X stuff "script ${i}_${COVERAGE}_n0${N_SIZE}.log$NL"
    screen -S "${i}_${COVERAGE}_${N_SIZE}.log" -p 0 -X stuff "./depth_calculus.sh; exec bash$NL"
    #screen -S "${i}_${COVERAGE}_${N_SIZE}.log" -p 0 -X stuff "exit$NL"
    done
...
!!! For each calling, split the VCF into per datasets, apply the max depth and min depth filters to obtain list of per-dataset to-remove sites, join those lists, remove those sites from each dataset VCF, and then split them at the population and individual level.
