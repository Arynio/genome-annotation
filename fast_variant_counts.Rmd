...
#intergenic filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf > filteredall_alt_intergenic.borrar.vcf
grep 'intergenic_region' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf >> filteredall_alt_intergenic.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_intergenic_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_intergenic_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_intergenic.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_intergenic_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_intergenic_homo_counts.borrar.txt
  done
  rm filteredall_alt_var_counts.borrar.txt
  rm filteredall_alt_homo_counts.borrar.txt
...
#intron filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf > filteredall_alt_intron.borrar.vcf
grep 'intron_variant' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf >> filteredall_alt_intron.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_intron_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_intron_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_intron.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_intron_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_intron_homo_counts.borrar.txt
  done
  rm filteredall_alt_var_counts.borrar.txt
  rm filteredall_alt_homo_counts.borrar.txt
...
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_intron_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_intron_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Synonymous filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf > filteredall_alt_synonymous.borrar.vcf
grep 'synonymous_variant' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf >> filteredall_alt_synonymous.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_synonymous_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_synonymous_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_synonymous.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_synonymous_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_synonymous_homo_counts.borrar.txt
  done
  rm filteredall_alt_var_counts.borrar.txt
  rm filteredall_alt_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_alt_synonymous_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_alt_synonymous_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Missense filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf > filteredall_alt_missense.borrar.vcf
grep 'missense_variant' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf >> filteredall_alt_missense.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_missense_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_missense_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_missense.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_missense_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_missense_homo_counts.borrar.txt
  done
  rm filteredall_alt_var_counts.borrar.txt
  rm filteredall_alt_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_missense_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_missense_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Misdel filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

bedtools intersect -a filteredall_alt_missense.borrar.vcf -b /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/provean/missense_variants_provean_scores_deleterious.txt -header > filteredall_alt_misdel.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_misdel_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_misdel_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_misdel.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_misdel_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_misdel_homo_counts.borrar.txt
  done
rm filteredall_alt_var_counts.borrar.txt
rm filteredall_alt_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_misdel_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_misdel_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Mistol filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

bedtools intersect -a filteredall_alt_missense.borrar.vcf -b /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/provean/missense_variants_provean_scores_tolerated.txt -header > filteredall_alt_mistol.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_mistol_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_mistol_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_mistol.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_mistol_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_mistol_homo_counts.borrar.txt
  done
rm filteredall_alt_var_counts.borrar.txt
rm filteredall_alt_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_mistol_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_mistol_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Nonsense filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf > filteredall_alt_nonsense.borrar.vcf
grep '|HIGH|' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf >> filteredall_alt_nonsense.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_nonsense_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_nonsense_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_nonsense.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_nonsense_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_nonsense_homo_counts.borrar.txt
  done
  rm filteredall_alt_var_counts.borrar.txt
  rm filteredall_alt_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_nonsense_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_nonsense_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#UCNE filteredall_alt
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf > filteredall_alt_UCNE.borrar.vcf
grep 'UCNE' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf >> filteredall_alt_UCNE.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_UCNE_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_alt_UCNE_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_alt.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_alt_UCNE.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_alt_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_alt_all_counts.borrar.txt > filteredall_alt_var_counts.borrar.txt
  awk '$1 == 2' filteredall_alt_all_counts.borrar.txt > filteredall_alt_homo_counts.borrar.txt
  VAR_N=$(<filteredall_alt_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_alt_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_alt_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_alt_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_alt_UCNE_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_alt_UCNE_homo_counts.borrar.txt
  done
  rm filteredall_alt_var_counts.borrar.txt
  rm filteredall_alt_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_UCNE_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_alt_UCNE_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
FILTER=("filteredall_alt") #filteredall #filtered5 #filtered2 #filteredall_alt
...
type="filteredall_alt" #filteredall #filtered5 #filtered2 #filteredall_alt
