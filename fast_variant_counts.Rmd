...
#intergenic filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf > filteredall_test_intergenic.borrar.vcf
grep 'intergenic_region' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf >> filteredall_test_intergenic.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_intergenic_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_intergenic_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_intergenic.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_intergenic_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_intergenic_homo_counts.borrar.txt
  done
  rm filteredall_test_var_counts.borrar.txt
  rm filteredall_test_homo_counts.borrar.txt
...
#intron filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf > filteredall_test_intron.borrar.vcf
grep 'intron_variant' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf >> filteredall_test_intron.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_intron_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_intron_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_intron.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_intron_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_intron_homo_counts.borrar.txt
  done
  rm filteredall_test_var_counts.borrar.txt
  rm filteredall_test_homo_counts.borrar.txt
...
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_intron_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_intron_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Synonymous filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf > filteredall_test_synonymous.borrar.vcf
grep 'synonymous_variant' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf >> filteredall_test_synonymous.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_synonymous_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_synonymous_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_synonymous.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_synonymous_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_synonymous_homo_counts.borrar.txt
  done
  rm filteredall_test_var_counts.borrar.txt
  rm filteredall_test_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_test_synonymous_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_test_synonymous_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Missense filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf > filteredall_test_missense.borrar.vcf
grep 'missense_variant' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf >> filteredall_test_missense.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_missense_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_missense_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_missense.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_missense_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_missense_homo_counts.borrar.txt
  done
  rm filteredall_test_var_counts.borrar.txt
  rm filteredall_test_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_missense_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_missense_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Misdel filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

bedtools intersect -a filteredall_test_missense.borrar.vcf -b /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/provean/missense_variants_provean_scores_deleterious.txt -header > filteredall_test_misdel.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_misdel_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_misdel_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_misdel.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_misdel_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_misdel_homo_counts.borrar.txt
  done
rm filteredall_test_var_counts.borrar.txt
rm filteredall_test_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_misdel_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_misdel_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Mistol filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

bedtools intersect -a filteredall_test_missense.borrar.vcf -b /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/provean/missense_variants_provean_scores_tolerated.txt -header > filteredall_test_mistol.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_mistol_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_mistol_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_mistol.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_mistol_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_mistol_homo_counts.borrar.txt
  done
rm filteredall_test_var_counts.borrar.txt
rm filteredall_test_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_mistol_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_mistol_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
#Nonsense filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf > filteredall_test_nonsense.borrar.vcf
grep '|HIGH|' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf >> filteredall_test_nonsense.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_nonsense_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_nonsense_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_nonsense.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_nonsense_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_nonsense_homo_counts.borrar.txt
  done
  rm filteredall_test_var_counts.borrar.txt
  rm filteredall_test_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_nonsense_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_nonsense_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
unset SSHPASS
...
#UCNE filteredall_test
cd /GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation

grep '#' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf > filteredall_test_UCNE.borrar.vcf
grep 'UCNE' c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf >> filteredall_test_UCNE.borrar.vcf
echo -e "individual\tvar_N\tallele_N" > filteredall_test_UCNE_var_counts.borrar.txt
echo -e "individual\tvar_N\tallele_N" > filteredall_test_UCNE_homo_counts.borrar.txt
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filteredall_varssubs_SNP_test.lr_ann.vcf)
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  bcftools view -Ou -s "${i}" filteredall_test_UCNE.borrar.vcf | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' > filteredall_test_all_counts.borrar.txt
  awk '$1 >= 1' filteredall_test_all_counts.borrar.txt > filteredall_test_var_counts.borrar.txt
  awk '$1 == 2' filteredall_test_all_counts.borrar.txt > filteredall_test_homo_counts.borrar.txt
  VAR_N=$(<filteredall_test_var_counts.borrar.txt wc -l)  
  VAR_H=$(<filteredall_test_homo_counts.borrar.txt wc -l)
  ALLELE_N=$(cut -f 1 filteredall_test_var_counts.borrar.txt | paste -sd+ | bc)
  ALLELE_H=$(cut -f 1 filteredall_test_homo_counts.borrar.txt | paste -sd+ | bc)
  echo -e "$i\t$VAR_N\t$ALLELE_N" >> filteredall_test_UCNE_var_counts.borrar.txt
  echo -e "$i\t$VAR_H\t$ALLELE_H" >> filteredall_test_UCNE_homo_counts.borrar.txt
  done
  rm filteredall_test_var_counts.borrar.txt
  rm filteredall_test_homo_counts.borrar.txt
...
#From outside the server:
export SSHPASS=$(cat /Users/dani/Documents/genomics_pass.txt)
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_UCNE_var_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
sshpass -e scp dkleinman@genomics-a.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/nmVCFs/c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov/annotation/filteredall_test_UCNE_homo_counts.borrar.txt /Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios
...
FILTER=("filteredall_test") #filteredall #filtered5 #filtered2 #filteredall_alt #filteredall_test
...
type="filteredall_test" #filteredall #filtered5 #filtered2 #filteredall_alt #filteredall_test
...
relativised_derived_allele_allele_ratio_ggplot <- ggplot(data=relativised_variants_and_subst_wg_alleleR, aes(population,ki_relative_value,colour=population)) +
  ...
  ylim(0.5,1.2) +
  ggtitle("ratio of varssubs relative to intronic and Kirov") +
  theme_bw() +
  theme(text=element_text(size=12,face="bold"),
        rect=element_rect(size=1),
        axis.line=element_line(colour="black"),
...
variants_and_subst_wg_alleleR <- variants_and_subst_wg %>% mutate(synonymous=synonymous_A/intergenic_A,missense=missense_A/intergenic_A,mistol=mistol_A/intergenic_A,misdel=misdel_A/intergenic_A,nonsense=nonsense_A/intergenic_A,UCNE=UCNE_A/intergenic_A) %>% select(c(1:3,20:25)) %>% gather(ratio,value,-species,-population,-sample,factor_key=T)
variants_and_subst_wg_alleleR
...
relativised_derived_allele_allele_ratio_ggplot <- ggplot(data=relativised_variants_and_subst_wg_alleleR, aes(population,ki_relative_value,colour=population)) +
  ...
  scale_y_continuous(breaks = seq(0.5, 1.2, by = 0.2)) +
  ylim(0.5,1.2) +
  ggtitle("ratio of varssubs relative to intergenic and Kirov") +
  theme_bw() +
  theme(text=element_text(size=12,face="bold"),
        rect=element_rect(size=1),
        axis.line=element_line(colour="black"),
  ...
  relativised_derived_allele_allele_ratio_ggplot
ggsave(paste0(type,"_derived_allele_allele_ratio_relative2interg_methodB.pdf"), width=15, height=15, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/")
...
variants_and_subst_wg_alleleR <- variants_and_subst_wg %>% mutate(synonymous=synonymous_A/synonymous_A,missense=missense_A/synonymous_A,mistol=mistol_A/synonymous_A,misdel=misdel_A/synonymous_A,nonsense=nonsense_A/synonymous_A,UCNE=UCNE_A/synonymous_A) %>% select(c(1:3,20:25)) %>% gather(ratio,value,-species,-population,-sample,factor_key=T)
variants_and_subst_wg_alleleR
...
relativised_derived_allele_allele_ratio_ggplot <- ggplot(data=relativised_variants_and_subst_wg_alleleR, aes(population,ki_relative_value,colour=population)) +
  ...
  scale_y_continuous(breaks = seq(0.5, 1.2, by = 0.2)) +
  ylim(0.5,1.2) +
  ggtitle("ratio of varssubs relative to synonymous and Kirov") +
  theme_bw() +
  theme(text=element_text(size=12,face="bold"),
        rect=element_rect(size=1),
        axis.line=element_line(colour="black"),
  ...
  relativised_derived_allele_allele_ratio_ggplot
ggsave(paste0(type,"_derived_allele_allele_ratio_relative2synonymous_methodB.pdf"), width=15, height=15, units="cm", device="pdf", path="/Users/dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/")
...
FILE=$(echo ${CALLING}_polarized_filtered2_${TYPE}.lr_ann.vcf) #This file was generated in section 11 after applying the per dataset depth filtering to the varssubs file.
...
-R $REF \
-V $FILE \
-o ${s}_varssubs.borrar \
-env \
--sample_file ${s}_samples.txt
echo "retrieving derived segregating positions for species" $s
bcftools view -i "AC/AN > 0 & AC/AN < 1" ${s}_varssubs.borrar -Ov -o ${s}_segregating.borrar
echo "retrieving derived fixed positions for species" $s
bcftools view -i "AC/AN = 1" ${s}_varssubs.borrar -Ov -o ${s}_fixed.borrar

INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filtered2_SNP.lr_ann.vcf | grep "ki")
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  grep -E '#|stop_gained' c_ll_fixed.borrar | bcftools view -Ou -s "${i}" | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' | awk '$1 >= 1' | wc -l
  done
  
INDIVIDUALS=$(bcftools query -l c_lp_sm_c_lp_do_c_ll_ki_c_ll_no_c_ll_po_nm2nm3_origcov_polarized_filtered2_SNP.lr_ann.vcf | grep "sm")
for i in ${INDIVIDUALS[@]}
  do
  echo "${i}"
  grep -E '#|stop_gained' c_lp_fixed.borrar | bcftools view -Ou -s "${i}" | bcftools query -f '%INFO/AC\t%INFO/AN[\t%GT]\n' | awk '$1 >= 1' | wc -l
  done
