...
scp dkleinman@genomics-b.ebd.csic.es:/home/GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/beagle_gl/*.depth* /Users/Dani/ownCloud/backup/annotation/IBD_analysis/beagle_gl
...
#Prepare files:
my_files_depthGlobal = list.files(path = "/Users/Dani/ownCloud/backup/annotation/IBD_analysis/beagle_gl",pattern="*.depthGlobal$") 
for (i in 1:length(my_files_depthGlobal)) { assign(my_files_depthGlobal[i], (scan(paste0("/Users/Dani/ownCloud/backup/annotation/IBD_analysis/beagle_gl/",my_files_depthGlobal[i],sep=""), sep = " ", dec = ".")) %>% .[!is.na(.)])}
mean_folds = 0.95
...
{
DF = read.table(paste0("/Users/Dani/ownCloud/backup/annotation/IBD_analysis/beagle_gl/",my_files_depthGlobal[i],sep=""),head=F, stringsAsFactors=F, check.names=FALSE)
...
plot_name=paste0("/Users/Dani/ownCloud/backup/annotation/IBD_analysis/beagle_gl/",my_files_depthGlobal[i],"_",mean_folds,".pdf",sep="")
ggsave(filename = plot_name)
}

#Write complete csv table:
write.table(x = depth_per_sample,file = paste("/Users/Dani/ownCloud/backup/annotation/IBD_analysis/beagle_gl/mean_sd_depthGlobal_lynx_per_pop_mean_folds_",mean_folds,".csv", sep= ""),quote=FALSE, col.names = FALSE, row.names = FALSE, sep= " ")
...
scp /Users/Dani/ownCloud/backup/annotation/IBD_analysis/beagle_gl/mean_sd_depthGlobal_lynx_per_pop_mean_folds_0.95.csv dkleinman@genomics-b.ebd.csic.es:/home/GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/beagle_gl/
...
We will try to use a script from the webpage (https://github.com/fgvieira/ngsF-HMM/blob/master/scripts/convert_ibd.pl)

Copio y pego el script en el servidor.
Si lo corro en B me da un problema por perl, pero en A corre perfectamente

Los archivos que necesita son:
...
```{bash}
cd /GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/

# ind_file        File with individual information (IND_ID on first column)
# Creo este archivo usando la bamlist.

cd /GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/beagle_gl

cat c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060.bamlist | sed 's/\/home\/GRUPOS\/grupolince\/lynx_genomes_5x\/BAM_files_final\///g' | sed 's/_recal_round-1.bam//g' > ../c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060.ind

sed '$!{:a;N;s/\n/\t/;ta}' c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060.ind > c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060_modif.ind


# pos_file        TSV file with position information (CHR,POS)
# Es el archivo con la información de cromosoma y longitud, la tenemos en la carpeta del genoma.
/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/Length_scaffolds_lp23_tab_separated 

# ibd_pos_file
# El archivo que nos genera el programa de IBD.
/GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/ngsF-HMM/c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060_ngsF-HMM.ibd

tail -n+2 /GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/ngsF-HMM/c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060_ngsF-HMM.ibd | head -n60 > /GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/ngsF-HMM/c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060_ngsF-HMM_modif.ibd

# El archivo que usamos

/GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/ngsF-HMM/c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060_ngsF-HMM_modif.ibd
```

## Lo lanzo
parece que da problemas con ind_file así que pruebo sin el
```{bash}

screen -S ibd_to_bed

./convert_ibd.pl --pos_file /GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/Length_scaffolds_lp23_tab_separated  --ibd_pos_file /GRUPOS/grupolince/lynx_genomes_5x/IBD_analysis/ngsF-HMM/c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060_ngsF-HMM_modif.ibd
```
