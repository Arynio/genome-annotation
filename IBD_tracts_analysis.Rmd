...
##Retrieve IBD tract coordinates for each individual. Generate BAM files with coordinates for each IBD tract (in scaffolds bigger than 1.6Mb).
...
INDIVIDUALS=$(cut -f5 c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060.ibdtract.bed | uniq | tail -n +2)
...
ibd_tract <- read_tsv ("/Users/dani/ownCloud/backup/g-w_analysis/IBD_analysis/ngsF-HMM/ibdtract_interval_counts.txt", col_names = T)

PENSAR CÓMO DIBUJARLO
