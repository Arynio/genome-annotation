...
cd $I_PATH
zcat c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060.genolike.beagle.gz | cut -f1 | cut -d$'_' -f1,2 --output-delimiter=' ' > variable_coordinates.list
...
cd $I_PATH
$NGSF --geno c_ll_ki-c_ll_no-c_ll_po-c_lp_do-c_lp_sm_n060.genolike.beagle.gz --lkl --pos variable_coordinates.list --n_ind 60 --n_sites n! --out $I_PATH/ngsF-HMM_test
