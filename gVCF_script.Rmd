...
java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx64g -jar $GATK \
-T HaplotypeCaller \
-R $REF \
...
scp dkleinman@genomics-b.ebd.csic.es:$B_PATH/c_gVCF_raw.stats /Users/Dani/ownCloud/backup/annotation/gVCFs_analysis/
