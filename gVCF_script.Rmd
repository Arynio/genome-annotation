...
grep -v '#' c_ll_species_SNPs_tagged_filtered.vcf | wc -l #8608569
...
-o c_ll_species_strict_filter.vcf

grep -v '#' c_ll_species_strict_filter.vcf | wc -l #6304158
...
-R $REF \
-V c_ll_species_SNPs_tagged_filtered.vcf \
-o c_ll_species_super_strict_filter.vcf

grep -v '#' c_ll_species_super_strict_filter.vcf | wc -l #4866975
...
for j in ${POP[@]}
  ...
  -T SelectVariants \
  -R $REF \
  -V $V_PATH/c_ll_species_strict_filter.vcf \
...
for j in ${POP[@]}
  ...
  java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms32g -Xmx64g -jar $GATK \
  -T SelectVariants \
  -R $REF \
  -V $V_PATH/c_ll_species_SNPs.vcf \
...
for j in ${POP[@]}
  ...
  -T SelectVariants \
  -R $REF \
  -V $V_PATH/c_ll_species_super_strict_filter.vcf \
