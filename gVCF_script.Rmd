...
=======
#5x genomes
>>>>>>> a0c58c22dfb406bf8435c4ca7c82e5e8eea00be0
...
for i in ${POP[@]}
  ...
  /opt/bcftools/bcftools view -c1 -Oz -S list_to_remove.txt --min-ac=1 --no-update -o "${i}".vcf.perpop all_c_ll_lp_renamed.vcf
