...
#Basic command to build a rooted ML tree without Balkans and with Mongolia, followed by a loop that runs TreeMix with different number of migration events
cd $O_PATH/intergenic_plus_1000
$T_PATH/treemix -i treemix_input_intergenic_rooted_wout_ba_w_mo.txt.gz -root Rufus -k 100 -o eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem
END=6
for i in $(seq 1 $END)
  do echo "migration events number = " $i
  $T_PATH/treemix -i treemix_input_intergenic_rooted_wout_ba_w_mo.txt.gz -root Rufus -k 100 -m ${i} -o eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_"${i}"_migration
  done
...
scp dkleinman@genomics-b.ebd.csic.es:/home/GRUPOS/grupolince/lynx_genomes_5x/TreeMix/intergenic_plus_1000/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem.* /Users/Dani/ownCloud/backup/annotation/TreeMix/intergenic/rooted/wout_ba_w_mo
scp dkleinman@genomics-b.ebd.csic.es:/home/GRUPOS/grupolince/lynx_genomes_5x/TreeMix/intergenic_plus_1000/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem*migration* /Users/Dani/ownCloud/backup/annotation/TreeMix/intergenic/rooted/wout_ba_w_mo/migration
...
poporder <- read.table(paste0(local_repo, "all_positions/rooted/all_pops/migration/pop_order"),header=T)
...
for (i in 1:6) {
  source("/Users/Dani/ownCloud/backup/annotation/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo/migration/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration_tree.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_tree(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo/migration/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration"))
  eurasian_lynx_rooted_migration
  dev.off()
  source("/Users/Dani/ownCloud/backup/annotation/TreeMix/plotting_funcs.R")
  pdf(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo/migration/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration_residuals.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_resid(paste0(local_repo,"intergenic/rooted/wout_ba_w_mo/migration/eurasian_lynx_intergenic_rooted_wout_ba_w_mo_out_stem_",i,"_migration"),paste0(local_repo,"intergenic/rooted/wout_ba_w_mo/migration/pop_order"))
  eurasian_lynx_rooted_migration
  dev.off()
}
...
#4b: Intergenic ThreePop. Run ThreePop admixture tests.
