...
$BCF view -R /GRUPOS/grupolince/Lyp_annotation_Apr14_final/LYPA23C.intergenic.PLUS1000.bed -Ov -o $V_PATH/intergenic_plus_1000/c_lr_SNPs_tagged_filtered_intergenic.vcf $V_PATH/c_lr_SNPs_tagged_filtered.vcf


$BCF view -R <(cat <(echo "CHROM CHROMST CHROMEND" /GRUPOS/grupolince/Lyp_annotation_Apr14_final/LYPA23C.intergenic.PLUS1000.bed)) -Ov -o $V_PATH/intergenic_plus_1000/c_lr_SNPs_intergenic.vcf $V_PATH/ll_ba_perpop_standard_filter.vcf


/opt/vcftools_0.1.13/cpp/vcftools --vcf $V_PATH/c_lr_SNPs_tagged_filtered.vcf --bed <(cat <(echo "CHROM CHROMST CHROMEND") /GRUPOS/grupolince/Lyp_annotation_Apr14_final/LYPA23C.intergenic.PLUS1000.bed) --out $V_PATH/c_lr_SNPs_tagged_filtered_intergenic.vcf
...
for pop in "${POPLIST[@]}"
  do
  $BCF view -R /GRUPOS/grupolince/Lyp_annotation_Apr14_final/LYPA23C.intergenic.PLUS1000.bed -Ov -o $V_PATH/intergenic_plus_1000/${pop}_perpop_standard_filter_intergenic.vcf $V_PATH/${pop}_perpop_standard_filter.vcf
  done
