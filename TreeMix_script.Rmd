...
scp dkleinman@genomics-b.ebd.csic.es:/home/GRUPOS/grupolince/lynx_genomes_5x/TreeMix/eurasian_lynx_rooted_out_stem*migration* /Users/Dani/ownCloud/backup/annotation/TreeMix/migration
...
mig_repo <- file.path("/Users/Dani/ownCloud/backup/annotation/TreeMix/migration/")
poporder <- c("Balkans","Carpathians","Norway","Bialowieza","Latvia","Kirov","Urals","Tuva","Ömnögovi","Töv","Khentii","Yakutia","Vladivostok","Rufus")
poporder <- read.tsv(paste0(mig_repo, "poporder.txt"),header=T)
...
source("/Users/Dani/ownCloud/backup/annotation/TreeMix/plotting_funcs.R")
pdf(paste0(local_repo,"eurasian_lynx_rooted_out_stem_tree.pdf"),width=20,height=10)
...
dev.off()
source("/Users/Dani/ownCloud/backup/annotation/TreeMix/plotting_funcs.R")
pdf(paste0(local_repo,"eurasian_lynx_rooted_out_stem_residuals.pdf"),width=20,height=10)
eurasian_lynx_rooted_out_stem <- plot_resid("/Users/Dani/ownCloud/backup/annotation/TreeMix/eurasian_lynx_rooted_out_stem",paste0(mig_repo,"pop_order"))
eurasian_lynx_rooted_out_stem
dev.off()

for (i in 1:6) {
  source("/Users/Dani/ownCloud/backup/annotation/TreeMix/plotting_funcs.R")
  pdf(paste0(mig_repo,"eurasian_lynx_rooted_out_stem_",i,"_migration_tree.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_tree(paste0(mig_repo,"eurasian_lynx_rooted_out_stem_",i,"_migration"))
  eurasian_lynx_rooted_migration
  dev.off()
  source("/Users/Dani/ownCloud/backup/annotation/TreeMix/plotting_funcs.R")
  pdf(paste0(mig_repo,"eurasian_lynx_rooted_out_stem_",i,"_migration_residuals.pdf"),width=20,height=10)
  eurasian_lynx_rooted_migration <- plot_resid(paste0(mig_repo,"eurasian_lynx_rooted_out_stem_",i,"_migration"),paste0(mig_repo,"pop_order"))
  eurasian_lynx_rooted_migration
  dev.off()
}
