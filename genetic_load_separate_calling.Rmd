...
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered1.lr_ann.vcf | wc -l #
...
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered2.lr_ann.vcf | wc -l #
...
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered3.lr_ann.vcf | wc -l #
...
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered4.lr_ann.vcf | wc -l #
...
echo $MIN_DP
echo $MAX_DP
$BCF filter -e "DP < ${MIN_DP} || DP > ${MAX_DP} || F_MISSING > X"XX -Ov -o $V_PATH/annotation/c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.vcf $V_PATH/annotation/c_lp_sm_c_lp_do_5x_var_polarized_filtered4.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.vcf | wc -l #
