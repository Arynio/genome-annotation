...
#5: Filter the annotated VCF. Subset the VCF files in order to keep only good quality biallelic SNP variants. 
...
cd $V_PATH/annotation
screen -S c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered1.lr_ann.log
script c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered1.lr_ann.log

bedtools subtract -a c_ll_ki_c_ll_no_c_ll_po_all_polarized.lr_ann.vcf -b /home/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/repeats_and_lowcomp_no_redundant_mappability.k75_lessthan90.bed -header > c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered1.lr_ann.vcf
grep -v '#' c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered1.lr_ann.vcf | wc -l #
...
cd $V_PATH/annotation
screen -S c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered2.lr_ann.log
script c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered2.lr_ann.log
...
-R $REF \
-V c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered1.lr_ann.vcf \
-o c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered2.lr_ann.vcf
grep -v '#' c_ll_ki_c_ll_no_c_ll_po_all_polarized_filtered2.lr_ann.vcf | wc -l #
