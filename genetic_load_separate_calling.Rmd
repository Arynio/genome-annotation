...
#First let's create the list with the 5x samples.
cd $G_PATH
rm c_lp_5x_gvcf_list
echo c_lp_do_0141_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_do_0144_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_do_0162_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_do_0163_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_do_0300_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_do_0333_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_do_0335_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_do_0444_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0134_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0155_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0156_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0161_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0206_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0208_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0213_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0226_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0276_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0320_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0325_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list
echo c_lp_sm_0450_recal_round-1.g.vcf.gz >> c_lp_5x_gvcf_list

#Perform variant calling (it won't include substitutions between species) of all c_lp samples. All gVCFs were generated before in section 1a of ll_phylogeography_VCFs.
cd $V_PATH
screen -S c_lp_sm_c_lp_do_5x_var.log
script c_lp_sm_c_lp_do_5x_var.log

cd $G_PATH
java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -jar $GATK \
-T GenotypeGVCFs \
-R $REF \
$(for var in $(cat c_lp_5x_gvcf_list); do echo -V ${var}" ";done) \
-o $V_PATH/c_lp_sm_c_lp_do_5x_var.vcf

cd $V_PATH
grep -v '#' c_lp_sm_c_lp_do_5x_var.vcf | wc -l #4331414 (vs. 4972251 with all lp individuals)

#No need to rename any samples, as all the ones included here have the proper name.
...
#First let's create the list with the 5x samples.
cd $G_PATH
rm c_lp_GP_gvcf_list
echo c_lp_do_0007_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_do_0153_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_do_0173_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_do_0443_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_sm_0138_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_sm_0140_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_sm_0185_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_sm_0186_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_sm_0221_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_sm_0298_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
echo c_lp_sm_0359_recal_round-1.g.vcf.gz >> c_lp_GP_gvcf_list
cat c_lp_GP_gvcf_list

#Perform variant calling (it won't include substitutions between species) of all c_lp samples. All gVCFs were generated before in section 1a of ll_phylogeography_VCFs.
cd $V_PATH
screen -S c_lp_sm_c_lp_do_GP_var.log
script c_lp_sm_c_lp_do_GP_var.log

cd $G_PATH
java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -jar $GATK \
-T GenotypeGVCFs \
-R $REF \
$(for var in $(cat c_lp_GP_gvcf_list); do echo -V ${var}" ";done) \
-o $V_PATH/c_lp_sm_c_lp_do_GP_var.temp.vcf
...
bcftools reheader -s lp_rename.txt -o c_lp_sm_c_lp_do_GP_var_renamed.vcf c_lp_sm_c_lp_do_GP_var.vcf #copy the VCF and rename the wrong named samples in the new VCF
rm c_lp_sm_c_lp_do_GP_var.vcf
mv c_lp_sm_c_lp_do_GP_var_renamed.vcf c_lp_sm_c_lp_do_GP_var.vcf

grep -v '#' c_lp_sm_c_lp_do_GP_var.vcf | wc -l #3804460
...
###For Lynx pardinus 5x only. Monomorphic positions (incl. substitutions) are NOT polarized. Grab them from the joint dataset.
...
###For Lynx pardinus GP only. Monomorphic positions (incl. substitutions) are NOT polarized. Grab them from the joint dataset.
...
rm c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0141_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0144_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0162_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0163_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0300_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0333_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0335_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0444_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0134_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0155_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0156_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0161_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0206_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0208_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0213_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0226_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0276_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0320_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0325_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0450_intergenic.bam >> c_lp_do-c_lp_sm_n020.intergenic.bamlist
mv c_lp_do-c_lp_sm_n020.intergenic.bamlist /home/dkleinman/datos/c_lp_depth_calculus/
...
screen -S c_lp_5x_depth_calculus.log
script c_lp_5x_depth_calculus.log

POP=(c_lp_do-c_lp_sm_n020)
REF="/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/lp23.fa"
THREADS=20                    # no. of computer cores used 20 = OK, >20 = ask people first!
REGIONFILE="/home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_capture/BAM_intergenic_capture_filtered/no_genes_Lypa_10000longest_center_final_slop20_dot.rf"
BAMLIST=$(ls /home/dkleinman/datos/c_lp_depth_calculus/"$POP".intergenic.bamlist) #intergenic BAMs are actually here: /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/
...
scp dkleinman@genomics-b.ebd.csic.es:/home/dkleinman/datos/c_lp_depth_calculus/*n020*.depth* /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/lp_depth
...
rm c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0007_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0153_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0173_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_do_0443_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0138_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0140_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0185_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0186_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0221_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0298_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
echo /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/c_lp_sm_0359_intergenic.bam >> c_lp_do-c_lp_sm_n011.intergenic.bamlist
mv c_lp_do-c_lp_sm_n011.intergenic.bamlist /home/dkleinman/datos/c_lp_depth_calculus/
...
screen -S c_lp_GP_depth_calculus.log
script c_lp_GP_depth_calculus.log

POP=(c_lp_do-c_lp_sm_n011)
REF="/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/lp23.fa"
THREADS=20                    # no. of computer cores used 20 = OK, >20 = ask people first!
REGIONFILE="/home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_capture/BAM_intergenic_capture_filtered/no_genes_Lypa_10000longest_center_final_slop20_dot.rf"
BAMLIST=$(ls /home/dkleinman/datos/c_lp_depth_calculus/"$POP".intergenic.bamlist) #intergenic BAMs are actually here: /home/GRUPOS/grupolince/lynx_genomes_5x/BAM_files_final/BAM_intergenic_5x/
...
scp dkleinman@genomics-b.ebd.csic.es:/home/dkleinman/datos/c_lp_depth_calculus/*n011*.depth* /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/lp_depth
...
#First upload the summary table to the server:
scp /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/lp_depth/mean_sd_depthGlobal_lynx_pardinus_5x_per_pop_mean_folds_0.95.csv dkleinman@genomics-b.ebd.csic.es:/home/dkleinman/datos/c_lp_depth_calculus/

#Separate in populations:
cd /home/dkleinman/datos/c_lp_depth_calculus/
POPS=$(cat /home/dkleinman/datos/c_lp_depth_calculus/mean_sd_depthGlobal_lynx_pardinus_5x_per_pop_mean_folds_0.95.csv | awk '{print $1}')
for POP in ${POPS[@]}
  do
  echo $POP
  grep "${POP} " /home/dkleinman/datos/c_lp_depth_calculus/mean_sd_depthGlobal_lynx_pardinus_5x_per_pop_mean_folds_0.95.csv > "$POP"_mean_sd_depthGlobal_lynx_pardinus_5x_per_pop_mean_folds_0.95.csv
  done
...
#First upload the summary table to the server:
scp /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/lp_depth/mean_sd_depthGlobal_lynx_pardinus_GP_per_pop_mean_folds_0.95.csv dkleinman@genomics-b.ebd.csic.es:/home/dkleinman/datos/c_lp_depth_calculus/

#Separate in populations:
cd /home/dkleinman/datos/c_lp_depth_calculus/
POPS=$(cat /home/dkleinman/datos/c_lp_depth_calculus/mean_sd_depthGlobal_lynx_pardinus_GP_per_pop_mean_folds_0.95.csv | awk '{print $1}')
for POP in ${POPS[@]}
  do
  echo $POP
  grep "${POP} " /home/dkleinman/datos/c_lp_depth_calculus/mean_sd_depthGlobal_lynx_pardinus_GP_per_pop_mean_folds_0.95.csv > "$POP"_mean_sd_depthGlobal_lynx_pardinus_GP_per_pop_mean_folds_0.95.csv
  done
...
#Remove repetitive regions and those with low mappability:
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_5x_var_polarized_filtered1.lr_ann.vcf.log
script c_lp_sm_c_lp_do_5x_var_polarized_filtered1.lr_ann.vcf.log

bedtools subtract -a c_lp_sm_c_lp_do_5x_var_polarized.lr_ann.vcf -b /home/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/repeats_and_lowcomp_no_redundant_mappability.k75_lessthan90.bed -header > c_lp_sm_c_lp_do_5x_var_polarized_filtered1.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered1.lr_ann.vcf | wc -l #1886397
...
#Remove repetitive regions and those with low mappability:
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_GP_var_polarized_filtered1.lr_ann.vcf.log
script c_lp_sm_c_lp_do_GP_var_polarized_filtered1.lr_ann.vcf.log

bedtools subtract -a c_lp_sm_c_lp_do_GP_var_polarized.lr_ann.vcf -b /home/GRUPOS/grupolince/reference_genomes/lynx_pardinus_genome/repeats_and_lowcomp_no_redundant_mappability.k75_lessthan90.bed -header > c_lp_sm_c_lp_do_GP_var_polarized_filtered1.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_GP_var_polarized_filtered1.lr_ann.vcf | wc -l #1577987
...
#During this step, all INDELs as well as all multiallelic and bad quality SNPs will be dropped from the respective VCFs.
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_5x_var_polarized_filtered2.lr_ann.log
script c_lp_sm_c_lp_do_5x_var_polarized_filtered2.lr_ann.log
...
-restrictAllelesTo BIALLELIC \
-R $REF \
-V c_lp_sm_c_lp_do_5x_var_polarized_filtered1.lr_ann.vcf \
-o c_lp_sm_c_lp_do_5x_var_polarized_filtered2.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered2.lr_ann.vcf | wc -l #1469071
...
#During this step, all INDELs as well as all multiallelic and bad quality SNPs will be dropped from the respective VCFs.
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_GP_var_polarized_filtered2.lr_ann.log
script c_lp_sm_c_lp_do_GP_var_polarized_filtered2.lr_ann.log
...
-restrictAllelesTo BIALLELIC \
-R $REF \
-V c_lp_sm_c_lp_do_GP_var_polarized_filtered1.lr_ann.vcf \
-o c_lp_sm_c_lp_do_GP_var_polarized_filtered2.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_GP_var_polarized_filtered2.lr_ann.vcf | wc -l #1191407
...
#Remove polarized ANC fixed variants (AF=0) or those that weren't polarizable (AA different from either REF or ALT):
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_5x_var_polarized_filtered3.lr_ann.log
script c_lp_sm_c_lp_do_5x_var_polarized_filtered3.lr_ann.log

bcftools view -e '(INFO/AA!=REF & INFO/AA!=ALT) | INFO/AF=0.00' c_lp_sm_c_lp_do_5x_var_polarized_filtered2.lr_ann.vcf > c_lp_sm_c_lp_do_5x_var_polarized_filtered3.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered3.lr_ann.vcf | wc -l #1380105
...
#Remove polarized ANC fixed variants (AF=0) or those that weren't polarizable (AA different from either REF or ALT):
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_GP_var_polarized_filtered3.lr_ann.log
script c_lp_sm_c_lp_do_GP_var_polarized_filtered3.lr_ann.log

bcftools view -e '(INFO/AA!=REF & INFO/AA!=ALT) | INFO/AF=0.00' c_lp_sm_c_lp_do_GP_var_polarized_filtered2.lr_ann.vcf > c_lp_sm_c_lp_do_GP_var_polarized_filtered3.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_GP_var_polarized_filtered3.lr_ann.vcf | wc -l #1119965
...
#Apply GATK's recommended filters, and then some.     
  ...
  #SOR: StrandOddsRatio (evaluates whether there's strand bias in the data). Default > 3.0.
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_5x_var_polarized_filtered4.lr_ann.log
script c_lp_sm_c_lp_do_5x_var_polarized_filtered4.lr_ann.log

java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx32g -jar $GATK \
-T SelectVariants \
-select "QUAL >= 30 && QD >= 2.0 && FS <= 60.0 && MQ >= 40.0 && MQRankSum >= -12.5 && ReadPosRankSum >= -8.0" \
-R $REF \
-V c_lp_sm_c_lp_do_5x_var_polarized_filtered3.lr_ann.vcf \
-o c_lp_sm_c_lp_do_5x_var_polarized_filtered4.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered4.lr_ann.vcf | wc -l #1212905
...
#Apply GATK's recommended filters, and then some.     
  ...
  #SOR: StrandOddsRatio (evaluates whether there's strand bias in the data). Default > 3.0.
cd $V_PATH/annotation
screen -S c_lp_sm_c_lp_do_GP_var_polarized_filtered4.lr_ann.log
script c_lp_sm_c_lp_do_GP_var_polarized_filtered4.lr_ann.log

java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx32g -jar $GATK \
-T SelectVariants \
-select "QUAL >= 30 && QD >= 2.0 && FS <= 60.0 && MQ >= 40.0 && MQRankSum >= -12.5 && ReadPosRankSum >= -8.0" \
-R $REF \
-V c_lp_sm_c_lp_do_GP_var_polarized_filtered3.lr_ann.vcf \
-o c_lp_sm_c_lp_do_GP_var_polarized_filtered4.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_GP_var_polarized_filtered4.lr_ann.vcf | wc -l #901666
...
###For Lynx pardinus 5x only (note: missingness filter won't be applied here since all belong to the same dataset).

```{r Apply per species filters, eval=FALSE, engine='bash'}

#First, for each species exclude those positions that have lower (higher) depth than the minimum (maximum) within 0.95 of the distribution, as calculated above:
cd $V_PATH/annotation/
screen -S c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.log
script c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.log

MIN_DP=$(cat /home/dkleinman/datos/c_lp_depth_calculus/c_lp_do-c_lp_sm_n020_mean_sd_depthGlobal_lynx_pardinus_5x_per_pop_mean_folds_0.95.csv | awk '{print $9}') #Obtained in section 5
MAX_DP=$(cat /home/dkleinman/datos/c_lp_depth_calculus/c_lp_do-c_lp_sm_n020_mean_sd_depthGlobal_lynx_pardinus_5x_per_pop_mean_folds_0.95.csv | awk '{print $8}') #Obtained in section 5
echo $MIN_DP
echo $MAX_DP
$BCF filter -e "DP < ${MIN_DP} || DP > ${MAX_DP}" -Ov -o $V_PATH/annotation/c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.vcf $V_PATH/annotation/c_lp_sm_c_lp_do_5x_var_polarized_filtered4.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.vcf | wc -l #1182577

```

###For Lynx pardinus GP only (note: missingness filter won't be applied here since all belong to the same dataset).

```{r Apply per species filters, eval=FALSE, engine='bash'}

#First, for each species exclude those positions that have lower (higher) depth than the minimum (maximum) within 0.95 of the distribution, as calculated above:
cd $V_PATH/annotation/
screen -S c_lp_sm_c_lp_do_GP_var_polarized_filtered5.lr_ann.log
script c_lp_sm_c_lp_do_GP_var_polarized_filtered5.lr_ann.log

MIN_DP=$(cat /home/dkleinman/datos/c_lp_depth_calculus/c_lp_do-c_lp_sm_n011_mean_sd_depthGlobal_lynx_pardinus_GP_per_pop_mean_folds_0.95.csv | awk '{print $9}') #Obtained in section 5
MAX_DP=$(cat /home/dkleinman/datos/c_lp_depth_calculus/c_lp_do-c_lp_sm_n011_mean_sd_depthGlobal_lynx_pardinus_GP_per_pop_mean_folds_0.95.csv | awk '{print $8}') #Obtained in section 5
echo $MIN_DP
echo $MAX_DP
$BCF filter -e "DP < ${MIN_DP} || DP > ${MAX_DP}" -Ov -o $V_PATH/annotation/c_lp_sm_c_lp_do_GP_var_polarized_filtered5.lr_ann.vcf $V_PATH/annotation/c_lp_sm_c_lp_do_GP_var_polarized_filtered4.lr_ann.vcf
grep -v '#' c_lp_sm_c_lp_do_GP_var_polarized_filtered5.lr_ann.vcf | wc -l #855528
...
cd $V_PATH/annotation/
screen -S lp_5x_perpop_var.lr_ann.log
script lp_5x_perpop_var.lr_ann.log
...
for j in ${POP[@]}
  ...
  echo "${j}"
  rm "${j}"_pop_list_to_remove.txt
  $BCF query -l $V_PATH/annotation/c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.vcf | grep "${j}" > "${j}"_pop_list_to_remove.txt
  cat "${j}"_pop_list_to_remove.txt
  mkdir "${j}"_5x_perpop_sep_calling
  java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx32g -jar $GATK \
  -T SelectVariants \
  -R $REF \
  -V $V_PATH/annotation/c_lp_sm_c_lp_do_5x_var_polarized_filtered5.lr_ann.vcf \
  -o $V_PATH/annotation/"${j}"_5x_perpop_sep_calling/"${j}"_5x_perpop_var.lr_ann.vcf \
  -env \
  --sample_file "${j}"_pop_list_to_remove.txt
  rm "${j}"_pop_list_to_remove.txt
  done
  
grep -v '#' c_lp_do_5x_perpop_var.lr_ann.vcf | wc -l #742518
grep -v '#' c_lp_sm_5x_perpop_var.lr_ann.vcf | wc -l #1058474
...
cd $V_PATH/annotation/
screen -S lp_GP_perpop_var.lr_ann.log
script lp_GP_perpop_var.lr_ann.log
...
for j in ${POP[@]}
  ...
  echo "${j}"
  rm "${j}"_pop_list_to_remove.txt
  $BCF query -l $V_PATH/annotation/c_lp_sm_c_lp_do_GP_var_polarized_filtered5.lr_ann.vcf | grep "${j}" > "${j}"_pop_list_to_remove.txt
  cat "${j}"_pop_list_to_remove.txt
  mkdir "${j}"_GP_perpop_sep_calling
  java -XX:MaxMetaspaceSize=1g -XX:+UseG1GC -XX:+UseStringDeduplication -Xms16g -Xmx32g -jar $GATK \
  -T SelectVariants \
  -R $REF \
  -V $V_PATH/annotation/c_lp_sm_c_lp_do_GP_var_polarized_filtered5.lr_ann.vcf \
  -o $V_PATH/annotation/"${j}"_GP_perpop_sep_calling/"${j}"_GP_perpop_var.lr_ann.vcf \
  -env \
  --sample_file "${j}"_pop_list_to_remove.txt
  rm "${j}"_pop_list_to_remove.txt
  done
  
grep -v '#' c_lp_do_GP_perpop_var.lr_ann.vcf | wc -l #525837
grep -v '#' c_lp_sm_GP_perpop_var.lr_ann.vcf | wc -l #784627
...
#Generate individual VCFs from the per species VCFs:
cd $V_PATH/annotation
screen -S lp_5x_individuals_var.lr_ann.log
script lp_5x_individuals_var.lr_ann.log
...
for i in ${POP[@]}
  do
  echo "${i}"
  mkdir $V_PATH/annotation/"${i}"_5x_individuals_sep_calling
  declare INDIVIDUALS=$(cat $G_PATH/c_lp_5x_gvcf_list | cut -c1-12 | uniq | grep "${i}")
  for j in ${INDIVIDUALS[@]}
    do
    echo "${j}"
    ID=$(echo "${j}")
    ...
    -T SelectVariants \
    -R $REF \
    -V $V_PATH/annotation/"${i}"_5x_perpop_sep_calling/"${i}"_5x_perpop_var.lr_ann.vcf \
    -o $V_PATH/annotation/"${i}"_5x_individuals_sep_calling/"${j}"_5x_individual_var.lr_ann.vcf \
    -env \
    -sn $ID
    done
  done
...
#Generate individual VCFs from the per species VCFs:
cd $V_PATH/annotation
screen -S lp_GP_individuals_var.lr_ann.log
script lp_GP_individuals_var.lr_ann.log
...
for i in ${POP[@]}
  do
  echo "${i}"
  mkdir $V_PATH/annotation/"${i}"_GP_individuals_sep_calling
  declare INDIVIDUALS=$(cat $G_PATH/c_lp_GP_gvcf_list | cut -c1-12 | uniq | grep "${i}")
  for j in ${INDIVIDUALS[@]}
    do
    echo "${j}"
    ID=$(echo "${j}")
    ...
    -T SelectVariants \
    -R $REF \
    -V $V_PATH/annotation/"${i}"_GP_perpop_sep_calling/"${i}"_GP_perpop_var.lr_ann.vcf \
    -o $V_PATH/annotation/"${i}"_GP_individuals_sep_calling/"${j}"_GP_individual_var.lr_ann.vcf \
    -env \
    -sn $ID
    done
  done
...
cd $V_PATH/annotation/
screen -S snpeff_5x_individual_summary_var.lr_ann.log
script snpeff_5x_individual_summary_var.lr_ann.log

rm snpeff_5x_individual_summary_var.lr_ann.txt
echo -e "species\tpopulation\tsample\ttotal_V\tintergenic_V\tintronic_V\tcoding\tsynonymous_V\tsynonymous_A\tmissense_V\tmissense_A\tnonsense_V\tnonsense_A\tmissense/synonymous_V\tmissense/synonymous_A" > snpeff_5x_individual_summary_var.lr_ann.txt
INDLIST=($(ls `find . -name '*5x_individual_var.lr_ann.vcf' -print`))
for i in "${INDLIST[@]}"
  do
  echo "${i}"
  ind=$(echo "${i}" | awk -F'[/]' '{print $3}')
  ...
  MISSENSE_SYNONYMOUS_V=$(echo "scale=3; $MISSENSE_V/$SYNONYMOUS_V" | bc)
  MISSENSE_SYNONYMOUS_A=$(echo "scale=3; $MISSENSE_A/$SYNONYMOUS_A" | bc)
  echo -e "$SPECIES\t$POPULATION\t$SAMPLE\t$TOTAL_V\t$INTERGENIC_V\t$INTRONIC_V\t$CODING_V\t$SYNONYMOUS_V\t$SYNONYMOUS_A\t$MISSENSE_V\t$MISSENSE_A\t$NONSENSE_V\t$NONSENSE_A\t$MISSENSE_SYNONYMOUS_V\t$MISSENSE_SYNONYMOUS_A" >> $V_PATH/annotation/snpeff_5x_individual_summary_var.lr_ann.txt
  done

scp dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/annotation/snpeff_5x_individual_summary_var.lr_ann.txt /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/sep_calling

```

###Heterozygotes and derived/derived homozygotes with UCNE.
...
cd $V_PATH/annotation/
screen -S snpeff_individual_summary_var_UCNE.lr_ann.log
script snpeff_individual_summary_var_UCNE.lr_ann.log

rm snpeff_individual_summary_var_UCNE.lr_ann.txt
echo -e "species\tpopulation\tsample\ttotal_V\tintergenic_V\tintronic_V\tcoding\tsynonymous_V\tsynonymous_A\tmissense_V\tmissense_A\tnonsense_V\tnonsense_A\tmissense/synonymous_V\tmissense/synonymous_A\tUCNE" > snpeff_individual_summary_var_UCNE.lr_ann.txt
INDLIST=($(ls `find . -name '*individual_var.lr_ann.vcf' -print` | grep -vE 'GP|5x'))
for i in "${INDLIST[@]}"
  do
  echo "${i}"
  ind=$(echo "${i}" | awk -F'[/]' '{print $3}')
  ...
  MISSENSE_SYNONYMOUS_V=$(echo "scale=3; $MISSENSE_V/$SYNONYMOUS_V" | bc)
  MISSENSE_SYNONYMOUS_A=$(echo "scale=3; $MISSENSE_A/$SYNONYMOUS_A" | bc)
  UCNE=$(grep 'UCNE' ${i} | wc -l)
  echo -e "$SPECIES\t$POPULATION\t$SAMPLE\t$TOTAL_V\t$INTERGENIC_V\t$INTRONIC_V\t$CODING_V\t$SYNONYMOUS_V\t$SYNONYMOUS_A\t$MISSENSE_V\t$MISSENSE_A\t$NONSENSE_V\t$NONSENSE_A\t$MISSENSE_SYNONYMOUS_V\t$MISSENSE_SYNONYMOUS_A\t$UCNE" >> $V_PATH/annotation/snpeff_individual_summary_var_UCNE.lr_ann.txt
  done

scp dkleinman@genomics-b.ebd.csic.es:/GRUPOS/grupolince/lynx_genomes_5x/VCFs_Dani/annotation/snpeff_individual_summary_var_UCNE.lr_ann.txt /Users/Dani/ownCloud/backup/g-w_analysis/genetic_load/snpeff_summary_ratios/sep_calling
