...
#Perform calling of all c_lp samples. All gVCFs were generated before in section 1a of ll_phylogeography_VCFs.
cd $V_PATH
screen -S c_lp_sm_c_lp_do.log
script c_lp_sm_c_lp_do.log
...
#Perform calling of all c_ll samples from Kirov, Norway and Poland (Bialowieza pop). All gVCFs were generated before in section 1a of ll_phylogeography_VCFs.

cd $V_PATH
screen -S c_ll_ki_c_ll_no_c_ll_po.log
script c_ll_ki_c_ll_no_c_ll_po.log
...
-o $V_PATH/c_ll_ki_c_ll_no_c_ll_po.vcf
...
#2: Set up SnpEff. I'll be following this manual for all SnpEff configuration purposes: http://snpeff.sourceforge.net/SnpEff_manual.html
