...
cd $V_PATH
grep -v '#' c_lp_sm_c_lp_do_BAM_recal_gVCF_on.vcf | wc -l #
...
grep -v '#' c_lp_sm_c_lp_do_BAM_recal_gVCF_off.vcf | wc -l #93186
...
cd $V_PATH
grep -v '#' c_lp_sm_c_lp_do_BAM_origi_gVCF_off.vcf | wc -l #103784
...
cd $V_PATH
grep -v '#' c_lp_sm_c_lp_do_BAM_origi_gVCF_on.vcf | wc -l #
